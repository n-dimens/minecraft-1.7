...
public class MapGenCavesHell extends MapGenBase
{
    ...
    protected void func_151543_a(long p_151543_1_, int p_151543_3_, int p_151543_4_, Block[] p_151543_5_, double p_151543_6_, double p_151543_8_, double p_151543_10_, float p_151543_12_, float p_151543_13_, float p_151543_14_, int p_151543_15_, int p_151543_16_, double p_151543_17_)
    {
        ...
        {
            double d6 = 1.5D + (double)(MathHelper.func_76126_a((float)p_151543_15_ * (float)Math.PI / (float)p_151543_16_) * p_151543_12_ * 1.0F);
            double d7 = d6 * p_151543_17_;
            float f5 = MathHelper.func_76134_b(p_151543_14_);
            float f6 = MathHelper.func_76126_a(p_151543_14_);
            p_151543_6_ += (double)(MathHelper.func_76134_b(p_151543_13_) * f5);
            p_151543_8_ += (double)f6;
            p_151543_10_ += (double)(MathHelper.func_76126_a(p_151543_13_) * f5);
            ...
            if (flag1 || random.nextInt(4) != 0)
            {
                ...
                {
                    int i4 = MathHelper.func_76128_c(p_151543_6_ - d6) - p_151543_3_ * 16 - 1;
                    int l1 = MathHelper.func_76128_c(p_151543_6_ + d6) - p_151543_3_ * 16 + 1;
                    int j4 = MathHelper.func_76128_c(p_151543_8_ - d7) - 1;
                    int i2 = MathHelper.func_76128_c(p_151543_8_ + d7) + 1;
                    int k4 = MathHelper.func_76128_c(p_151543_10_ - d6) - p_151543_4_ * 16 - 1;
                    int j2 = MathHelper.func_76128_c(p_151543_10_ + d6) - p_151543_4_ * 16 + 1;
    ...
    protected void func_151538_a(World p_151538_1_, int p_151538_2_, int p_151538_3_, int p_151538_4_, int p_151538_5_, Block[] p_151538_6_)
    {
        ...
        for (int j1 = 0; j1 < i1; ++j1)
        {
            ...
            {
                this.func_151544_a(this.field_75038_b.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, d0, d1, d2);
            ...
            for (int l1 = 0; l1 < k1; ++l1)
            {
                ...
                this.func_151543_a(this.field_75038_b.nextLong(), p_151538_4_, p_151538_5_, p_151538_6_, d0, d1, d2, f2 * 2.0F, f, f1, 0, 0, 0.5D);
            }
        }
    }
}