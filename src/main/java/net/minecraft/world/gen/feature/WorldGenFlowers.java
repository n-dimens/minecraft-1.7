...
public class WorldGenFlowers extends WorldGenerator
{
    ...
    public boolean func_76484_a(World p_76484_1_, Random p_76484_2_, int p_76484_3_, int p_76484_4_, int p_76484_5_)
    {
        for (int l = 0; l < 64; ++l)
        {
            ...
            if (p_76484_1_.func_147437_c(i1, j1, k1) && (!p_76484_1_.field_73011_w.field_76576_e || j1 < 255) && this.field_150552_a.func_149718_j(p_76484_1_, i1, j1, k1))
            {
                p_76484_1_.func_147465_d(i1, j1, k1, this.field_150552_a, this.field_150551_b, 2);
            }
        }
