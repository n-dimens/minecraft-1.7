    ...
    public void func_147587_b(int p_147587_1_, int p_147587_2_, int p_147587_3_, int p_147587_4_, int p_147587_5_)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            if (entityplayermp != null && entityplayermp.world == this.field_72782_b && entityplayermp.func_145782_y() != p_147587_1_)
            {
                ...
                double d2 = (double)p_147587_4_ - entityplayermp.field_70161_v;

                if (d0 * d0 + d1 * d1 + d2 * d2 < 1024.0D)
                {
                    entityplayermp.field_71135_a.func_147359_a(new S25PacketBlockBreakAnim(p_147587_1_, p_147587_2_, p_147587_3_, p_147587_4_, p_147587_5_));
                }
            }
        }
    }
