...
public class EntityClientPlayerMP extends EntityPlayerSP
{
    ...
    public void func_71166_b()
    {
        ...
        if (flag != this.field_71171_cn)
        {
            ...
            this.field_71171_cn = flag;
        }

        boolean flag1 = this.func_70093_af();

        if (flag1 != this.field_71170_cm)
        {
            if (flag1)
            {
            ...
            this.field_71170_cm = flag1;
        }

        double d0 = this.field_70165_t - this.field_71179_j;
        double d1 = this.field_70121_D.field_72338_b - this.field_71177_cg;
        double d2 = this.field_70161_v - this.field_71175_ci;
        double d3 = (double)(this.field_70177_z - this.field_71176_cj);
        double d4 = (double)(this.field_70125_A - this.field_71172_ck);
    ...
    public EntityItem func_71040_bB(boolean p_71040_1_)
    {
        ...
        this.field_71174_a.func_147297_a(new C07PacketPlayerDigging(i, 0, 0, 0, 0));
        return null;
    }
