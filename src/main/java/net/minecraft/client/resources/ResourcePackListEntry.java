...
public abstract class ResourcePackListEntry implements GuiListExtended.IGuiListEntry
{
    ...
    public void func_148279_a(int p_148279_1_, int p_148279_2_, int p_148279_3_, int p_148279_4_, int p_148279_5_, Tessellator p_148279_6_, int p_148279_7_, int p_148279_8_, boolean p_148279_9_)
    {
        ...
        i2 = this.field_148317_a.field_71466_p.func_78256_a(s);
        ...
        this.field_148317_a.field_71466_p.func_78261_a(s, p_148279_2_ + 32 + 2, p_148279_3_ + 1, 16777215);
        List list = this.field_148317_a.field_71466_p.func_78271_c(this.func_148311_a(), 157);

        for (int j2 = 0; j2 < 2 && j2 < list.size(); ++j2)
        {
            this.field_148317_a.field_71466_p.func_78261_a((String)list.get(j2), p_148279_2_ + 32 + 2, p_148279_3_ + 12 + 10 * j2, 8421504);
        }
    }
