...
public class EntityPickupFX extends EntityFX
{
    ...
    public void func_70539_a(Tessellator p_70539_1_, float p_70539_2_, float p_70539_3_, float p_70539_4_, float p_70539_5_, float p_70539_6_, float p_70539_7_)
    {
        ...
        int i = this.func_70070_b(p_70539_2_);
        int j = i % 65536;
        int k = i / 65536;
        ...
        d7 -= field_70554_ao;
        d8 -= field_70555_ap;
        RenderManager.field_78727_a.func_147940_a(this.field_70591_a, (double)((float)d6), (double)((float)d7), (double)((float)d8), this.field_70591_a.field_70177_z, p_70539_2_);
    }
