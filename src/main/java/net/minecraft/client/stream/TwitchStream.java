...
public class TwitchStream implements BroadcastController.BroadcastListener, ChatController.ChatListener, IngestServerTester.IngestTestListener, IStream
{
    ...
    public void func_152922_k()
    {
        if (this.field_152951_c.func_152850_m() && !this.field_152951_c.func_152839_p())
        {
            ...
            if (flag)
            {
                ...
                tessellator.func_78374_a(0.0D, (double)f1, 0.0D, 0.0D, (double)f3);
                tessellator.func_78374_a((double)f, (double)f1, 0.0D, (double)f2, (double)f3);
                tessellator.func_78374_a((double)f, 0.0D, 0.0D, (double)f2, 0.0D);
    ...
    public void func_152892_c(ErrorCode p_152892_1_)
    {
        ...
        if (p_152892_1_ == ErrorCode.TTV_EC_SOUNDFLOWER_NOT_INSTALLED)
        {
            ...
            chatcomponenttranslation.func_150256_b().func_150241_a(new ClickEvent(ClickEvent.Action.OPEN_URL, "https://help.mojang.com/customer/portal/articles/1374877-configuring-soundflower-for-streaming-on-apple-computers"));
            chatcomponenttranslation.func_150256_b().func_150228_d(Boolean.valueOf(true));
            ...
            chatcomponenttranslation1.func_150256_b().func_150238_a(EnumChatFormatting.DARK_RED);
            this.field_152953_e.field_71456_v.func_146158_b().func_146227_a(chatcomponenttranslation1);
        }
        else
        {
            ...
            this.field_152953_e.field_71456_v.func_146158_b().func_146227_a(chatcomponenttranslation);
        }
    }
    ...
    public void func_152903_a(ChatMessage[] p_152903_1_)
    {
        ...
        for (int j = 0; j < i; ++j)
        {
            ...
            if (this.func_152940_a(chatmessage.modes, chatmessage.subscriptions, this.field_152953_e.field_71474_y.field_152409_S))
            {
                ...
                chatcomponenttext1.func_150257_a(new ChatComponentTranslation("stream.userinfo.chatTooltip", new Object[0]));
                ...
                while (iterator.hasNext())
                {
                    ...
                    chatcomponenttext1.func_150258_a("\n");
                    chatcomponenttext1.func_150257_a(ichatcomponent);
                }

                chatcomponenttext.func_150256_b().func_150209_a(new HoverEvent(HoverEvent.Action.SHOW_TEXT, chatcomponenttext1));
                chatcomponenttext.func_150256_b().func_150241_a(new ClickEvent(ClickEvent.Action.TWITCH_USER_INFO, chatmessage.userName));
                this.field_152953_e.field_71456_v.func_146158_b().func_146227_a(chatcomponenttranslation);
            }
        }
    }
