...
public class RenderEndPortal extends TileEntitySpecialRenderer
{
    ...
    public void func_147500_a(TileEntityEndPortal p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
    {
        ...
        for (int i = 0; i < 16; ++i)
        {
            ...
            tessellator.func_78377_a(p_147500_2_, p_147500_4_ + (double)f4, p_147500_6_ + 1.0D);
            tessellator.func_78377_a(p_147500_2_ + 1.0D, p_147500_4_ + (double)f4, p_147500_6_ + 1.0D);
            tessellator.func_78377_a(p_147500_2_ + 1.0D, p_147500_4_ + (double)f4, p_147500_6_);
