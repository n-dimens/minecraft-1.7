...
public class TileEntitySignRenderer extends TileEntitySpecialRenderer
{
    ...
    public void func_147500_a(TileEntitySign p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_)
    {
        ...
        {
            int j = p_147500_1_.func_145832_p();
            f3 = 0.0F;
        ...
        for (int i = 0; i < p_147500_1_.field_145915_a.length; ++i)
        {
            String s = p_147500_1_.field_145915_a[i];

            if (i == p_147500_1_.field_145918_i)
            {
                s = "> " + s + " <";
                fontrenderer.func_78276_b(s, -fontrenderer.func_78256_a(s) / 2, i * 10 - p_147500_1_.field_145915_a.length * 5, b0);
            }
            else
            {
                fontrenderer.func_78276_b(s, -fontrenderer.func_78256_a(s) / 2, i * 10 - p_147500_1_.field_145915_a.length * 5, b0);
