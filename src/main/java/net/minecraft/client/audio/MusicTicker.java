    ...
    public void func_73660_a()
    {
        ...
        if (this.field_147678_c != null)
        {
            if (!musictype.func_148635_a().equals(this.field_147678_c.func_147650_b()))
            {
                ...
                this.field_147676_d = MathHelper.func_76136_a(this.field_147679_a, 0, musictype.func_148634_b() / 2);
            }

            if (!this.field_147677_b.func_147118_V().func_147692_c(this.field_147678_c))
            {
                this.field_147678_c = null;
                this.field_147676_d = Math.min(MathHelper.func_76136_a(this.field_147679_a, musictype.func_148634_b(), musictype.func_148633_c()), this.field_147676_d);
            }
        }
