...
public class Main
{
    ...
    public static void main(String[] p_main_0_)
    {
        ...
        ArgumentAcceptingOptionSpec argumentacceptingoptionspec9 = optionparser.accepts("username").withRequiredArg().defaultsTo("Player" + Minecraft.func_71386_F() % 1000L, new String[0]);
        ...
        if (s6 != null)
        {
            minecraft.func_71367_a(s6, ((Integer)optionset.valueOf(argumentacceptingoptionspec1)).intValue());
        }
