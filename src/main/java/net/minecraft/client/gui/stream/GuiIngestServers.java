...
public class GuiIngestServers extends GuiScreen
{
    ...
    class ServerList extends GuiSlot
    {
        ...
        {
            IngestServer ingestserver = GuiIngestServers.this.field_146297_k.func_152346_Z().func_152925_v()[p_148126_1_];
            String s = ingestserver.serverUrl.replaceAll("\\{stream_key\\}", "");
            String s1 = (int)ingestserver.bitrateKbps + " kbps";
            String s2 = null;
            IngestServerTester ingestservertester = GuiIngestServers.this.field_146297_k.func_152346_Z().func_152932_y();
            ...
            GuiIngestServers.this.func_73731_b(GuiIngestServers.this.field_146289_q, ingestserver.serverName, p_148126_2_ + 2, p_148126_3_ + 5, 16777215);
            GuiIngestServers.this.func_73731_b(GuiIngestServers.this.field_146289_q, s, p_148126_2_ + 2, p_148126_3_ + GuiIngestServers.this.field_146289_q.field_78288_b + 5 + 3, 3158064);
            GuiIngestServers.this.func_73731_b(GuiIngestServers.this.field_146289_q, s1, this.func_148137_d() - 5 - GuiIngestServers.this.field_146289_q.func_78256_a(s1), p_148126_3_ + 5, 8421504);

            if (s2 != null)
            {
                GuiIngestServers.this.func_73731_b(GuiIngestServers.this.field_146289_q, s2, this.func_148137_d() - 5 - GuiIngestServers.this.field_146289_q.func_78256_a(s2), p_148126_3_ + 5 + 3 + GuiIngestServers.this.field_146289_q.field_78288_b, 8421504);
            }
        }
