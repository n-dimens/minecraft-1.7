...
public class GuiStreamOptions extends GuiScreen
{
    ...
    public void func_73866_w_()
    {
        ...
        for (k = 0; k < j; ++k)
        {
            ...
            {
                this.field_146292_n.add(new GuiOptionButton(options.func_74381_c(), this.field_146294_l / 2 - 155 + i % 2 * 160, this.field_146295_m / 6 + 24 * (i >> 1), options, this.field_152318_h.func_74297_c(options)));
            }
    ...
    protected void func_146284_a(GuiButton p_146284_1_)
    {
        if (p_146284_1_.field_146124_l)
        {
            ...
            {
                GameSettings.Options options = ((GuiOptionButton)p_146284_1_).func_146136_c();
                this.field_152318_h.func_74306_a(options, 1);
                p_146284_1_.field_146126_j = this.field_152318_h.func_74297_c(GameSettings.Options.func_74379_a(p_146284_1_.field_146127_k));

                if (this.field_146297_k.func_152346_Z().func_152934_n() && options != GameSettings.Options.STREAM_CHAT_ENABLED && options != GameSettings.Options.STREAM_CHAT_USER_FILTER)
                {
