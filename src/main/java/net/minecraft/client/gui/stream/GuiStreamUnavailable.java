...
public class GuiStreamUnavailable extends GuiScreen
{
    ...
    {
        this.func_146276_q_();
        int k = Math.max((int)((double)this.field_146295_m * 0.85D / 2.0D - (double)((float)(this.field_152323_r.size() * this.field_146289_q.field_78288_b) / 2.0F)), 50);
        this.func_73732_a(this.field_146289_q, this.field_152324_f.func_150254_d(), this.field_146294_l / 2, k - this.field_146289_q.field_78288_b * 2, 16777215);

        for (Iterator iterator = this.field_152323_r.iterator(); iterator.hasNext(); k += this.field_146289_q.field_78288_b)
        {
            String s = (String)iterator.next();
            this.func_73732_a(this.field_146289_q, s, this.field_146294_l / 2, k, 10526880);
        }
    ...
    public static void func_152321_a(GuiScreen p_152321_0_)
    {
        ...
        if (!OpenGlHelper.field_148823_f)
        {
            ...
            minecraft.func_147108_a(new GuiStreamUnavailable(p_152321_0_, GuiStreamUnavailable.Reason.NO_FBO, arraylist));
        }
        ...
        else if (istream.func_152912_E() != null)
        {
            ...
            minecraft.func_147108_a(new GuiStreamUnavailable(p_152321_0_, GuiStreamUnavailable.Reason.INITIALIZATION_FAILURE, list));
        }
        else
        {
