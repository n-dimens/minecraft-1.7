...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    protected void func_146284_a(GuiButton p_146284_1_)
    {
        if (p_146284_1_.field_146124_l)
        {
            ...
            {
                String s4 = ((ServerListEntryNormal)iguilistentry).func_148296_a().field_78847_a;
            ...
            else if (p_146284_1_.field_146127_k == 7 && iguilistentry instanceof ServerListEntryNormal)
            {
                ...
                this.field_146811_z = new ServerData(serverdata.field_78847_a, serverdata.field_78845_b);
            ...
            if (j >= 0)
            {
                if (p_73869_2_ == 200)
                {
                    if (func_146272_n())
                    {
                        ...
                        {
                            this.field_146804_i.func_78857_a(j, j - 1);
                ...
                else if (p_73869_2_ == 208)
                {
                    if (func_146272_n())
                    {
                        if (j < this.field_146804_i.func_78856_c() - 1)
                        {
                            this.field_146804_i.func_78857_a(j, j + 1);
    ...
    public void func_146796_h()
    {
        ...
        else if (iguilistentry instanceof ServerListEntryLanDetected)
        {
            ...
            this.func_146791_a(new ServerData(lanserver.func_77487_a(), lanserver.func_77488_b(), true));
        }
    }
