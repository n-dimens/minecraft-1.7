...
public class GuiContainerCreative extends InventoryEffectRenderer
{
    ...
    protected void func_146984_a(Slot p_146984_1_, int p_146984_2_, int p_146984_3_, int p_146984_4_)
    {
        ...
        if (p_146984_1_ == null && field_147058_w != CreativeTabs.field_78036_m.func_78021_a() && p_146984_4_ != 5)
        {
            ...
            if (inventoryplayer.func_70445_o() != null)
            {
                ...
                if (p_146984_3_ == 1)
                {
                    itemstack1 = inventoryplayer.func_70445_o().func_77979_a(1);
        ...
        else
        {
            ...
            {
                for (l = 0; l < this.field_146297_k.field_71439_g.field_71069_bz.func_75138_a().size(); ++l)
                {
            ...
            else
            {
                ...
                if (field_147058_w == CreativeTabs.field_78036_m.func_78021_a())
                {
                    ...
                    {
                        itemstack = p_146984_1_.func_75209_a(p_146984_3_ == 0 ? 1 : p_146984_1_.func_75211_c().func_77976_d());
                ...
                else
                {
                    ...
                    {
                        itemstack = this.field_147002_h.func_75139_a(p_146984_1_.field_75222_d).func_75211_c();
                        this.field_146297_k.field_71442_b.func_78761_a(itemstack, p_146984_1_.field_75222_d - this.field_147002_h.field_75151_b.size() + 9 + 36);
                    }
                }
            }
        }
    ...
    private void func_147050_b(CreativeTabs p_147050_1_)
    {
        ...
        containercreative.field_148330_a.clear();
        p_147050_1_.func_78018_a(containercreative.field_148330_a);
        ...
        if (p_147050_1_ == CreativeTabs.field_78036_m)
        {
            ...
            {
                GuiContainerCreative.CreativeSlot creativeslot = new GuiContainerCreative.CreativeSlot((Slot)container.field_75151_b.get(j), j);
    ...
    public void func_73863_a(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        if (!this.field_147065_z && flag && p_73863_1_ >= i1 && p_73863_2_ >= j1 && p_73863_1_ < k1 && p_73863_2_ < l1)
        {
        ...
        {
            this.field_147067_x = ((float)(p_73863_2_ - j1) - 7.5F) / ((float)(l1 - j1) - 15.0F);
    ...
    protected void func_146285_a(ItemStack p_146285_1_, int p_146285_2_, int p_146285_3_)
    {
        if (field_147058_w == CreativeTabs.field_78027_g.func_78021_a())
        {
            ...
            for (int i1 = 0; i1 < list.size(); ++i1)
            {
                if (i1 == 0)
                {
                    list.set(i1, p_146285_1_.func_77953_t().field_77937_e + (String)list.get(i1));
                }
                else
                {
