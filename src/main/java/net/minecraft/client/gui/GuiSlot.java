...
public abstract class GuiSlot
{
    ...
    protected abstract void func_148126_a(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_, Tessellator p_148126_5_, int p_148126_6_, int p_148126_7_);
    ...
    public void func_148128_a(int p_148128_1_, int p_148128_2_, float p_148128_3_)
    {
            ...
            if (Mouse.isButtonDown(0) && this.func_148125_i())
            {
                if (this.field_148157_o == -1.0F)
                {
                    ...
                    if (p_148128_2_ >= this.field_148153_b && p_148128_2_ <= this.field_148154_c)
                    {
                        ...
                        {
                            boolean flag = j2 == this.field_148168_r && Minecraft.func_71386_F() - this.field_148167_s < 250L;
        ...
        tessellator.func_78374_a((double)this.field_148152_e, (double)(this.field_148153_b + b0), 0.0D, 0.0D, 1.0D);
        tessellator.func_78374_a((double)this.field_148151_d, (double)(this.field_148153_b + b0), 0.0D, 1.0D, 1.0D);
        tessellator.func_78384_a(0, 255);
        tessellator.func_78374_a((double)this.field_148151_d, (double)this.field_148153_b, 0.0D, 1.0D, 0.0D);
        tessellator.func_78374_a((double)this.field_148152_e, (double)this.field_148153_b, 0.0D, 0.0D, 0.0D);
        tessellator.func_78381_a();
        tessellator.func_78382_b();
        tessellator.func_78384_a(0, 255);
        tessellator.func_78374_a((double)this.field_148152_e, (double)this.field_148154_c, 0.0D, 0.0D, 1.0D);
        tessellator.func_78374_a((double)this.field_148151_d, (double)this.field_148154_c, 0.0D, 1.0D, 1.0D);
        tessellator.func_78384_a(0, 0);
        tessellator.func_78374_a((double)this.field_148151_d, (double)(this.field_148154_c - b0), 0.0D, 1.0D, 0.0D);
        tessellator.func_78374_a((double)this.field_148152_e, (double)(this.field_148154_c - b0), 0.0D, 0.0D, 0.0D);
        tessellator.func_78381_a();
        i3 = this.func_148135_f();
        ...
        if (i3 > 0)
        {
            ...
            tessellator.func_78382_b();
            tessellator.func_78384_a(0, 255);
            tessellator.func_78374_a((double)l, (double)this.field_148154_c, 0.0D, 0.0D, 1.0D);
            tessellator.func_78374_a((double)i1, (double)this.field_148154_c, 0.0D, 1.0D, 1.0D);
            tessellator.func_78374_a((double)i1, (double)this.field_148153_b, 0.0D, 1.0D, 0.0D);
            tessellator.func_78374_a((double)l, (double)this.field_148153_b, 0.0D, 0.0D, 0.0D);
            tessellator.func_78381_a();
            tessellator.func_78382_b();
    ...
    private void func_148136_c(int p_148136_1_, int p_148136_2_, int p_148136_3_, int p_148136_4_)
    {
        ...
        tessellator.func_78374_a((double)this.field_148152_e, (double)p_148136_2_, 0.0D, 0.0D, (double)((float)p_148136_2_ / f));
        tessellator.func_78374_a((double)(this.field_148152_e + this.field_148155_a), (double)p_148136_2_, 0.0D, (double)((float)this.field_148155_a / f), (double)((float)p_148136_2_ / f));
        tessellator.func_78384_a(4210752, p_148136_3_);
        tessellator.func_78374_a((double)(this.field_148152_e + this.field_148155_a), (double)p_148136_1_, 0.0D, (double)((float)this.field_148155_a / f), (double)((float)p_148136_1_ / f));
        tessellator.func_78374_a((double)this.field_148152_e, (double)p_148136_1_, 0.0D, 0.0D, (double)((float)p_148136_1_ / f));
        tessellator.func_78381_a();
    }
