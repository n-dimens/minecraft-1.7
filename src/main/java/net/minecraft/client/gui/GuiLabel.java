...
public class GuiLabel extends Gui
{
    ...
    public void func_146159_a(Minecraft p_146159_1_, int p_146159_2_, int p_146159_3_)
    {
        if (this.field_146172_j)
        {
            ...
            for (int i1 = 0; i1 < this.field_146173_k.size(); ++i1)
            {
                ...
                {
                    this.func_73732_a(this.field_146164_r, (String)this.field_146173_k.get(i1), this.field_146162_g + this.field_146167_a / 2, l + i1 * 10, this.field_146168_n);
                }
                else
                {
                    this.func_73731_b(this.field_146164_r, (String)this.field_146173_k.get(i1), this.field_146162_g, l + i1 * 10, this.field_146168_n);
                }
            }
        }
    }
    ...
    protected void func_146160_b(Minecraft p_146160_1_, int p_146160_2_, int p_146160_3_)
    {
        if (this.field_146171_m)
        {
            ...
            func_73734_a(i1, j1, i1 + k, j1 + l, this.field_146169_o);
            this.func_73730_a(i1, i1 + k, j1, this.field_146166_p);
            this.func_73730_a(i1, i1 + k, j1 + l, this.field_146165_q);
            this.func_73728_b(i1, j1, j1 + l, this.field_146166_p);
            this.func_73728_b(i1 + k, j1, j1 + l, this.field_146165_q);
        }
    }
}