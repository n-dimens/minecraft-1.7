...
public class GuiSelectWorld extends GuiScreen implements GuiYesNoCallback
{
    ...
    {
        String s1 = I18n.func_135052_a("selectWorld.deleteQuestion", new Object[0]);
        String s2 = "\'" + p_152129_1_ + "\' " + I18n.func_135052_a("selectWorld.deleteWarning", new Object[0]);
        String s3 = I18n.func_135052_a("selectWorld.deleteButton", new Object[0]);
        String s4 = I18n.func_135052_a("gui.cancel", new Object[0]);
    ...
    class List extends GuiSlot
    {
        ...
        protected void func_148126_a(int p_148126_1_, int p_148126_2_, int p_148126_3_, int p_148126_4_, Tessellator p_148126_5_, int p_148126_6_, int p_148126_7_)
        {
            ...
            GuiSelectWorld.this.func_73731_b(GuiSelectWorld.this.field_146289_q, s, p_148126_2_ + 2, p_148126_3_ + 1, 16777215);
            GuiSelectWorld.this.func_73731_b(GuiSelectWorld.this.field_146289_q, s1, p_148126_2_ + 2, p_148126_3_ + 12, 8421504);
            GuiSelectWorld.this.func_73731_b(GuiSelectWorld.this.field_146289_q, s2, p_148126_2_ + 2, p_148126_3_ + 12 + 10, 8421504);
        }
    }
}