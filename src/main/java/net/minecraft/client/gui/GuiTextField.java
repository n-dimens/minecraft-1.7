...
public class GuiTextField extends Gui
{
    ...
    public void func_146192_a(int p_146192_1_, int p_146192_2_, int p_146192_3_)
    {
        ...
        if (this.field_146213_o && p_146192_3_ == 0)
        {
            ...
            this.func_146190_e(this.field_146211_a.func_78269_a(s, l).length() + this.field_146225_q);
        }
    }
    ...
    public void func_146194_f()
    {
        if (this.func_146176_q())
        {
            ...
            if (s.length() > 0)
            {
                ...
                j1 = this.field_146211_a.func_78261_a(s1, l, i1, i);
            }
            ...
            {
                this.field_146211_a.func_78261_a(s.substring(j), j1, i1, i);
            }
            ...
            if (flag1)
            {
                ...
                {
                    this.field_146211_a.func_78261_a("_", k1, i1, i);
                }
            }
    ...
    private void func_146188_c(int p_146188_1_, int p_146188_2_, int p_146188_3_, int p_146188_4_)
    {
        ...
        tessellator.func_78377_a((double)p_146188_1_, (double)p_146188_4_, 0.0D);
        tessellator.func_78377_a((double)p_146188_3_, (double)p_146188_4_, 0.0D);
        tessellator.func_78377_a((double)p_146188_3_, (double)p_146188_2_, 0.0D);
        tessellator.func_78377_a((double)p_146188_1_, (double)p_146188_2_, 0.0D);
    ...
    public void func_146199_i(int p_146199_1_)
    {
        ...
        if (this.field_146211_a != null)
        {
            ...
            String s = this.field_146211_a.func_78269_a(this.field_146216_j.substring(this.field_146225_q), k);
            int l = s.length() + this.field_146225_q;

            if (p_146199_1_ == this.field_146225_q)
            {
                this.field_146225_q -= this.field_146211_a.func_78262_a(this.field_146216_j, k, true).length();
            }
