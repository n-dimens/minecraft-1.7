...
public class ModelIronGolem extends ModelBase
{
    ...
    public ModelIronGolem(float p_i1162_1_, float p_i1162_2_)
    {
        short short1 = 128;
        short short2 = 128;
        this.field_78178_a = (new ModelRenderer(this)).func_78787_b(short1, short2);
        ...
        this.field_78176_b = (new ModelRenderer(this)).func_78787_b(short1, short2);
        ...
        this.field_78177_c = (new ModelRenderer(this)).func_78787_b(short1, short2);
        ...
        this.field_78174_d = (new ModelRenderer(this)).func_78787_b(short1, short2);
        ...
        this.field_78175_e = (new ModelRenderer(this, 0, 22)).func_78787_b(short1, short2);
        ...
        this.field_78173_f = (new ModelRenderer(this, 0, 22)).func_78787_b(short1, short2);
    ...
    {
        this.field_78178_a.field_78796_g = p_78087_4_ / (180F / (float)Math.PI);
        this.field_78178_a.field_78795_f = p_78087_5_ / (180F / (float)Math.PI);
