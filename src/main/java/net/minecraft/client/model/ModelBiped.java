...
public class ModelBiped extends ModelBase
{
    ...
    public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        this.field_78112_f.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F + (float)Math.PI) * 2.0F * p_78087_2_ * 0.5F;
        ...
        this.field_78124_i.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F + (float)Math.PI) * 1.4F * p_78087_2_;
        this.field_78123_h.field_78796_g = 0.0F;
        this.field_78124_i.field_78796_g = 0.0F;

        if (this.field_78093_q)
        {
            this.field_78112_f.field_78795_f += -((float)Math.PI / 5F);
            this.field_78113_g.field_78795_f += -((float)Math.PI / 5F);
            this.field_78123_h.field_78795_f = -((float)Math.PI * 2F / 5F);
            this.field_78124_i.field_78795_f = -((float)Math.PI * 2F / 5F);
            this.field_78123_h.field_78796_g = ((float)Math.PI / 10F);
            this.field_78124_i.field_78796_g = -((float)Math.PI / 10F);
        }

        if (this.field_78119_l != 0)
        {
            this.field_78113_g.field_78795_f = this.field_78113_g.field_78795_f * 0.5F - ((float)Math.PI / 10F) * (float)this.field_78119_l;
        }

        if (this.field_78120_m != 0)
        {
            this.field_78112_f.field_78795_f = this.field_78112_f.field_78795_f * 0.5F - ((float)Math.PI / 10F) * (float)this.field_78120_m;
        }
        ...
        if (this.field_78095_p > -9990.0F)
        {
            ...
            this.field_78115_e.field_78796_g = MathHelper.func_76126_a(MathHelper.func_76129_c(f6) * (float)Math.PI * 2.0F) * 0.2F;
            ...
            f6 *= f6;
            f6 = 1.0F - f6;
            f7 = MathHelper.func_76126_a(f6 * (float)Math.PI);
            float f8 = MathHelper.func_76126_a(this.field_78095_p * (float)Math.PI) * -(this.field_78116_c.field_78795_f - 0.7F) * 0.75F;
            this.field_78112_f.field_78795_f = (float)((double)this.field_78112_f.field_78795_f - ((double)f7 * 1.2D + (double)f8));
        ...
        if (this.field_78118_o)
        {
            ...
            this.field_78112_f.field_78795_f = -((float)Math.PI / 2F) + this.field_78116_c.field_78795_f;
            this.field_78113_g.field_78795_f = -((float)Math.PI / 2F) + this.field_78116_c.field_78795_f;
