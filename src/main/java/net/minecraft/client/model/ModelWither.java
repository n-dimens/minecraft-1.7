...
public class ModelWither extends ModelBase
{
    ...
    public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        this.field_82905_a[1].field_78795_f = (0.065F + 0.05F * f6) * (float)Math.PI;
        ...
        this.field_82905_a[2].field_78795_f = (0.265F + 0.1F * f6) * (float)Math.PI;
        this.field_82904_b[0].field_78796_g = p_78087_4_ / (180F / (float)Math.PI);
        this.field_82904_b[0].field_78795_f = p_78087_5_ / (180F / (float)Math.PI);
    }
    ...
    public void func_78086_a(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_)
    {
        ...
        for (int i = 1; i < 3; ++i)
        {
            this.field_82904_b[i].field_78796_g = (entitywither.func_82207_a(i - 1) - p_78086_1_.field_70761_aq) / (180F / (float)Math.PI);
            this.field_82904_b[i].field_78795_f = entitywither.func_82210_r(i - 1) / (180F / (float)Math.PI);
        }
    }
}