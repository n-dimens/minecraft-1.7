...
public class ModelOcelot extends ModelBase
{
    ...
    {
        this.field_78156_g.field_78795_f = p_78087_5_ / (180F / (float)Math.PI);
        this.field_78156_g.field_78796_g = p_78087_4_ / (180F / (float)Math.PI);

        if (this.field_78163_i != 3)
        {
            this.field_78162_h.field_78795_f = ((float)Math.PI / 2F);
            ...
            if (this.field_78163_i == 2)
            {
                ...
                this.field_78160_c.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F + (float)Math.PI + 0.3F) * 1.0F * p_78087_2_;
                this.field_78157_d.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F + (float)Math.PI) * 1.0F * p_78087_2_;
                this.field_78155_f.field_78795_f = 1.7278761F + ((float)Math.PI / 10F) * MathHelper.func_76134_b(p_78087_1_) * p_78087_2_;
            }
            else
            {
                this.field_78161_a.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F) * 1.0F * p_78087_2_;
                this.field_78159_b.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F + (float)Math.PI) * 1.0F * p_78087_2_;
                this.field_78160_c.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F + (float)Math.PI) * 1.0F * p_78087_2_;
                this.field_78157_d.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F) * 1.0F * p_78087_2_;

                if (this.field_78163_i == 1)
                {
                    this.field_78155_f.field_78795_f = 1.7278761F + ((float)Math.PI / 4F) * MathHelper.func_76134_b(p_78087_1_) * p_78087_2_;
                }
                else
                {
    ...
    public void func_78086_a(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_)
    {
        ...
        if (entityocelot.func_70093_af())
        {
            ...
            this.field_78158_e.field_78795_f = ((float)Math.PI / 2F);
            this.field_78155_f.field_78795_f = ((float)Math.PI / 2F);
        ...
        {
            this.field_78162_h.field_78795_f = ((float)Math.PI / 4F);
            ...
            this.field_78161_a.field_78795_f = this.field_78159_b.field_78795_f = -((float)Math.PI / 2F);
