...
public class ModelWitch extends ModelVillager
{
    ...
    public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        float f6 = 0.01F * (float)(p_78087_7_.func_145782_y() % 10);
        this.field_82898_f.field_78795_f = MathHelper.func_76126_a((float)p_78087_7_.field_70173_aa * f6) * 4.5F * (float)Math.PI / 180.0F;
        this.field_82898_f.field_78796_g = 0.0F;
        this.field_82898_f.field_78808_h = MathHelper.func_76134_b((float)p_78087_7_.field_70173_aa * f6) * 2.5F * (float)Math.PI / 180.0F;
