...
public class ModelChicken extends ModelBase
{
    ...
    {
        this.field_78142_a.field_78795_f = p_78087_5_ / (180F / (float)Math.PI);
        this.field_78142_a.field_78796_g = p_78087_4_ / (180F / (float)Math.PI);
        ...
        this.field_78140_b.field_78795_f = ((float)Math.PI / 2F);
        this.field_78141_c.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F) * 1.4F * p_78087_2_;
        this.field_78138_d.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F + (float)Math.PI) * 1.4F * p_78087_2_;
