...
public class ModelHorse extends ModelBase
{
    ...
    public void func_78086_a(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_)
    {
        ...
        float f3 = this.func_110683_a(p_78086_1_.field_70760_ar, p_78086_1_.field_70761_aq, p_78086_4_);
        float f4 = this.func_110683_a(p_78086_1_.field_70758_at, p_78086_1_.field_70759_as, p_78086_4_);
        float f5 = p_78086_1_.field_70127_C + (p_78086_1_.field_70125_A - p_78086_1_.field_70127_C) * p_78086_4_;
        float f6 = f4 - f3;
        ...
        if (p_78086_3_ > 0.2F)
        {
            f7 += MathHelper.func_76134_b(p_78086_2_ * 0.4F) * 0.15F * p_78086_3_;
        }

        EntityHorse entityhorse = (EntityHorse)p_78086_1_;
        float f8 = entityhorse.func_110258_o(p_78086_4_);
        float f9 = entityhorse.func_110223_p(p_78086_4_);
        float f10 = 1.0F - f9;
        ...
        float f12 = (float)p_78086_1_.field_70173_aa + p_78086_4_;
        float f13 = MathHelper.func_76134_b(p_78086_2_ * 0.6662F + (float)Math.PI);
        ...
        this.field_110709_a.field_78795_f = 0.5235988F + f7;
        this.field_110709_a.field_78796_g = f6 / (180F / (float)Math.PI);
        this.field_110709_a.field_78795_f = f9 * (0.2617994F + f7) + f8 * 2.18166F + (1.0F - Math.max(f9, f8)) * this.field_110709_a.field_78795_f;
        this.field_110709_a.field_78796_g = f9 * (f6 / (180F / (float)Math.PI)) + (1.0F - Math.max(f9, f8)) * this.field_110709_a.field_78796_g;
        this.field_110709_a.field_78797_d = f9 * -6.0F + f8 * 11.0F + (1.0F - Math.max(f9, f8)) * this.field_110709_a.field_78797_d;
        this.field_110709_a.field_78798_e = f9 * -1.0F + f8 * -10.0F + (1.0F - Math.max(f9, f8)) * this.field_110709_a.field_78798_e;
        this.field_110712_l.field_78797_d = f9 * 9.0F + f10 * this.field_110712_l.field_78797_d;
        this.field_110713_m.field_78798_e = f9 * 18.0F + f10 * this.field_110713_m.field_78798_e;
        this.field_110695_H.field_78797_d = f9 * 5.5F + f10 * this.field_110695_H.field_78797_d;
        this.field_110695_H.field_78798_e = f9 * 15.0F + f10 * this.field_110695_H.field_78798_e;
        this.field_110715_k.field_78795_f = f9 * -((float)Math.PI / 4F) + f10 * this.field_110715_k.field_78795_f;
        ...
        this.field_110707_b.field_78798_e = 0.02F - f11 * 1.0F;
        this.field_110708_c.field_78798_e = 0.0F + f11 * 1.0F;
        ...
        this.field_110707_b.field_78795_f = 0.0F - 0.09424778F * f11;
        this.field_110708_c.field_78795_f = 0.0F + 0.15707964F * f11;
        ...
        this.field_110687_G.field_78795_f = f14 / 5.0F;
        this.field_110695_H.field_78795_f = -f14 / 5.0F;
        float f15 = ((float)Math.PI / 2F);
        float f16 = ((float)Math.PI * 3F / 2F);
        float f17 = -1.0471976F;
        float f18 = 0.2617994F * f9;
        float f19 = MathHelper.func_76134_b(f12 * 0.6F + (float)Math.PI);
        this.field_110688_A.field_78797_d = -2.0F * f9 + 9.0F * f10;
        this.field_110688_A.field_78798_e = -2.0F * f9 + -8.0F * f10;
        ...
        this.field_110719_v.field_78797_d = this.field_110711_o.field_78797_d + MathHelper.func_76126_a(((float)Math.PI / 2F) + f18 + f10 * -f13 * 0.5F * p_78086_3_) * 7.0F;
        this.field_110719_v.field_78798_e = this.field_110711_o.field_78798_e + MathHelper.func_76134_b(((float)Math.PI * 3F / 2F) + f18 + f10 * -f13 * 0.5F * p_78086_3_) * 7.0F;
        this.field_110721_y.field_78797_d = this.field_110722_x.field_78797_d + MathHelper.func_76126_a(((float)Math.PI / 2F) + f18 + f10 * f13 * 0.5F * p_78086_3_) * 7.0F;
        this.field_110721_y.field_78798_e = this.field_110722_x.field_78798_e + MathHelper.func_76134_b(((float)Math.PI * 3F / 2F) + f18 + f10 * f13 * 0.5F * p_78086_3_) * 7.0F;
        float f20 = (-1.0471976F + f19) * f9 + f14 * f10;
        float f21 = (-1.0471976F + -f19) * f9 + -f14 * f10;
        this.field_110689_B.field_78797_d = this.field_110688_A.field_78797_d + MathHelper.func_76126_a(((float)Math.PI / 2F) + f20) * 7.0F;
        this.field_110689_B.field_78798_e = this.field_110688_A.field_78798_e + MathHelper.func_76134_b(((float)Math.PI * 3F / 2F) + f20) * 7.0F;
        this.field_110685_E.field_78797_d = this.field_110684_D.field_78797_d + MathHelper.func_76126_a(((float)Math.PI / 2F) + f21) * 7.0F;
        this.field_110685_E.field_78798_e = this.field_110684_D.field_78798_e + MathHelper.func_76134_b(((float)Math.PI * 3F / 2F) + f21) * 7.0F;
        this.field_110711_o.field_78795_f = f18 + -f13 * 0.5F * p_78086_3_ * f10;
        this.field_110719_v.field_78795_f = -0.08726646F * f9 + (-f13 * 0.5F * p_78086_3_ - Math.max(0.0F, f13 * 0.5F * p_78086_3_)) * f10;
        this.field_110718_w.field_78795_f = this.field_110719_v.field_78795_f;
        this.field_110722_x.field_78795_f = f18 + f13 * 0.5F * p_78086_3_ * f10;
        this.field_110721_y.field_78795_f = -0.08726646F * f9 + (f13 * 0.5F * p_78086_3_ - Math.max(0.0F, -f13 * 0.5F * p_78086_3_)) * f10;
        this.field_110720_z.field_78795_f = this.field_110721_y.field_78795_f;
        this.field_110688_A.field_78795_f = f20;
        this.field_110689_B.field_78795_f = (this.field_110688_A.field_78795_f + (float)Math.PI * Math.max(0.0F, 0.2F + f19 * 0.2F)) * f9 + (f14 + Math.max(0.0F, f13 * 0.5F * p_78086_3_)) * f10;
        this.field_110690_C.field_78795_f = this.field_110689_B.field_78795_f;
        this.field_110684_D.field_78795_f = f21;
        this.field_110685_E.field_78795_f = (this.field_110684_D.field_78795_f + (float)Math.PI * Math.max(0.0F, 0.2F - f19 * 0.2F)) * f9 + (-f14 + Math.max(0.0F, -f13 * 0.5F * p_78086_3_)) * f10;
        ...
        if (flag1)
        {
            this.field_110696_I.field_78797_d = f9 * 0.5F + f10 * 2.0F;
            this.field_110696_I.field_78798_e = f9 * 11.0F + f10 * 2.0F;
            ...
            this.field_110702_R.field_78795_f = f7;
            this.field_110701_S.field_78795_f = f7;
            ...
            {
                this.field_110691_L.field_78795_f = f14 / 3.0F;
                this.field_110692_M.field_78795_f = f14 / 3.0F;
                this.field_110693_N.field_78795_f = f14 / 3.0F;
                this.field_110694_O.field_78795_f = f14 / 3.0F;
                this.field_110691_L.field_78808_h = f14 / 5.0F;
                this.field_110692_M.field_78808_h = f14 / 5.0F;
                this.field_110693_N.field_78808_h = -f14 / 5.0F;
                this.field_110694_O.field_78808_h = -f14 / 5.0F;
            }
        }
        ...
        if (flag)
        {
            this.field_110712_l.field_78796_g = MathHelper.func_76134_b(f12 * 0.7F);
            f15 = 0.0F;
        }
        else
        {
        ...
        this.field_110712_l.field_78795_f = f15;
        this.field_110713_m.field_78795_f = f15;
        this.field_110710_n.field_78795_f = -0.2618F + f15;
    }
}