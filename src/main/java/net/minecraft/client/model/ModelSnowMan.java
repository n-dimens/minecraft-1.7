...
public class ModelSnowMan extends ModelBase
{
    ...
    public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        this.field_78195_c.field_78796_g = p_78087_4_ / (180F / (float)Math.PI);
        this.field_78195_c.field_78795_f = p_78087_5_ / (180F / (float)Math.PI);
        this.field_78196_a.field_78796_g = p_78087_4_ / (180F / (float)Math.PI) * 0.25F;
        float f6 = MathHelper.func_76126_a(this.field_78196_a.field_78796_g);
        float f7 = MathHelper.func_76134_b(this.field_78196_a.field_78796_g);
        ...
        this.field_78192_d.field_78800_c = f7 * 5.0F;
        this.field_78192_d.field_78798_e = -f6 * 5.0F;
        this.field_78193_e.field_78800_c = -f7 * 5.0F;
        this.field_78193_e.field_78798_e = f6 * 5.0F;
    }
