...
public class ModelBook extends ModelBase
{
    ...
    public ModelBook()
    {
        ...
        this.field_78097_g.field_78796_g = ((float)Math.PI / 2F);
    }
    ...
    {
        float f6 = (MathHelper.func_76126_a(p_78087_1_ * 0.02F) * 0.1F + 1.25F) * p_78087_4_;
        this.field_78102_a.field_78796_g = (float)Math.PI + f6;
        this.field_78100_b.field_78796_g = -f6;
        this.field_78101_c.field_78796_g = f6;
        this.field_78098_d.field_78796_g = -f6;
        this.field_78099_e.field_78796_g = f6 - f6 * 2.0F * p_78087_2_;
        this.field_78096_f.field_78796_g = f6 - f6 * 2.0F * p_78087_3_;
        this.field_78101_c.field_78800_c = MathHelper.func_76126_a(f6);
        this.field_78098_d.field_78800_c = MathHelper.func_76126_a(f6);
        this.field_78099_e.field_78800_c = MathHelper.func_76126_a(f6);
        this.field_78096_f.field_78800_c = MathHelper.func_76126_a(f6);
    }
}