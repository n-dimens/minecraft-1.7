...
public class ModelWolf extends ModelBase
{
    ...
    public void func_78086_a(EntityLivingBase p_78086_1_, float p_78086_2_, float p_78086_3_, float p_78086_4_)
    {
        ...
        {
            this.field_78183_b.func_78793_a(0.0F, 14.0F, 2.0F);
            this.field_78183_b.field_78795_f = ((float)Math.PI / 2F);
            ...
            this.field_78181_d.field_78795_f = MathHelper.func_76134_b(p_78086_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_78086_3_;
            this.field_78182_e.field_78795_f = MathHelper.func_76134_b(p_78086_2_ * 0.6662F + (float)Math.PI) * 1.4F * p_78086_3_;
    ...
    public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        this.field_78185_a.field_78795_f = p_78087_5_ / (180F / (float)Math.PI);
        this.field_78185_a.field_78796_g = p_78087_4_ / (180F / (float)Math.PI);
