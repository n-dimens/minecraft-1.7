...
public class ModelSilverfish extends ModelBase
{
    ...
    public void func_78088_a(Entity p_78088_1_, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float p_78088_7_)
    {
        ...
        for (i = 0; i < this.field_78171_a.length; ++i)
        {
            this.field_78171_a[i].func_78785_a(p_78088_7_);
        }

        for (i = 0; i < this.field_78169_b.length; ++i)
        {
            this.field_78169_b[i].func_78785_a(p_78088_7_);
        }
    }
    ...
    public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        for (int i = 0; i < this.field_78171_a.length; ++i)
        {
            this.field_78171_a[i].field_78796_g = MathHelper.func_76134_b(p_78087_3_ * 0.9F + (float)i * 0.15F * (float)Math.PI) * (float)Math.PI * 0.05F * (float)(1 + Math.abs(i - 2));
            this.field_78171_a[i].field_78800_c = MathHelper.func_76126_a(p_78087_3_ * 0.9F + (float)i * 0.15F * (float)Math.PI) * (float)Math.PI * 0.2F * (float)Math.abs(i - 2);
        }
