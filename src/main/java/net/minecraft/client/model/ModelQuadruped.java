...
public class ModelQuadruped extends ModelBase
{
    ...
    public void func_78087_a(float p_78087_1_, float p_78087_2_, float p_78087_3_, float p_78087_4_, float p_78087_5_, float p_78087_6_, Entity p_78087_7_)
    {
        ...
        this.field_78150_a.field_78795_f = p_78087_5_ / (180F / (float)Math.PI);
        this.field_78150_a.field_78796_g = p_78087_4_ / (180F / (float)Math.PI);
        this.field_78148_b.field_78795_f = ((float)Math.PI / 2F);
        this.field_78149_c.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F) * 1.4F * p_78087_2_;
        this.field_78146_d.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F + (float)Math.PI) * 1.4F * p_78087_2_;
        this.field_78147_e.field_78795_f = MathHelper.func_76134_b(p_78087_1_ * 0.6662F + (float)Math.PI) * 1.4F * p_78087_2_;
