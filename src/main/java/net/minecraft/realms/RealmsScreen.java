...
public class RealmsScreen
{
    ...
    {
        ResourceLocation resourcelocation = AbstractClientPlayer.func_110311_f(p_bindFace_0_);

        if (resourcelocation == null)
        {
            resourcelocation = AbstractClientPlayer.func_110311_f("default");
        }

        AbstractClientPlayer.func_110304_a(resourcelocation, p_bindFace_0_);
