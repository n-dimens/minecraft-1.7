...
public class BlockRedstoneComparator extends BlockRedstoneDiode implements ITileEntityProvider
{
    ...
    protected int func_149903_h(World p_149903_1_, int p_149903_2_, int p_149903_3_, int p_149903_4_, int p_149903_5_)
    {
        ...
        int k1 = p_149903_2_ + Direction.field_71583_a[j1];
        int l1 = p_149903_4_ + Direction.field_71581_b[j1];
        Block block = p_149903_1_.func_147439_a(k1, p_149903_3_, l1);

        if (block.func_149740_M())
        {
            i1 = block.func_149736_g(p_149903_1_, k1, p_149903_3_, l1, Direction.field_71580_e[j1]);
        }
    ...
    public boolean func_149727_a(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        int j1 = flag1 ? 4 : 0;
        j1 |= flag ? 8 : 0;
        p_149727_1_.func_72908_a((double)p_149727_2_ + 0.5D, (double)p_149727_3_ + 0.5D, (double)p_149727_4_ + 0.5D, "random.click", 0.3F, flag1 ? 0.55F : 0.5F);
        p_149727_1_.func_72921_c(p_149727_2_, p_149727_3_, p_149727_4_, j1 | i1 & 3, 2);
    ...
    protected void func_149897_b(World p_149897_1_, int p_149897_2_, int p_149897_3_, int p_149897_4_, Block p_149897_5_)
    {
        ...
        {
            int l = p_149897_1_.func_72805_g(p_149897_2_, p_149897_3_, p_149897_4_);
    ...
    {
        int l = p_149972_1_.func_72805_g(p_149972_2_, p_149972_3_, p_149972_4_);
        ...
        if (j1 != i1 || !this.func_149969_d(l))
        {
            ...
            if (flag1 && !flag)
            {
                p_149972_1_.func_72921_c(p_149972_2_, p_149972_3_, p_149972_4_, l & -9, 2);
            }
            else if (!flag1 && flag)
            {
                p_149972_1_.func_72921_c(p_149972_2_, p_149972_3_, p_149972_4_, l | 8, 2);
            }
