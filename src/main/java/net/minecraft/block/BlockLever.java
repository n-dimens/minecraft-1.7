...
public class BlockLever extends Block
{
    ...
    public void func_149689_a(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        if (i1 == func_149819_b(1))
        {
            ...
            {
                p_149689_1_.func_72921_c(p_149689_2_, p_149689_3_, p_149689_4_, 5 | j1, 2);
            }
            else
            {
                p_149689_1_.func_72921_c(p_149689_2_, p_149689_3_, p_149689_4_, 6 | j1, 2);
            }
        }
        else if (i1 == func_149819_b(0))
        {
            if ((MathHelper.func_76128_c((double)(p_149689_5_.field_70177_z * 4.0F / 360.0F) + 0.5D) & 1) == 0)
            {
                p_149689_1_.func_72921_c(p_149689_2_, p_149689_3_, p_149689_4_, 7 | j1, 2);
            }
            else
            {
                p_149689_1_.func_72921_c(p_149689_2_, p_149689_3_, p_149689_4_, 0 | j1, 2);
            }
        }
    }
    ...
    public boolean func_149727_a(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        else
        {
            ...
            p_149727_1_.func_72908_a((double)p_149727_2_ + 0.5D, (double)p_149727_3_ + 0.5D, (double)p_149727_4_ + 0.5D, "random.click", 0.3F, k1 > 0 ? 0.6F : 0.5F);
