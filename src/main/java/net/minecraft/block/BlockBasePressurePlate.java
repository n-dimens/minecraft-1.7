...
public abstract class BlockBasePressurePlate extends Block
{
    ...
    public void func_149674_a(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        ...
        {
            int l = this.func_150060_c(p_149674_1_.func_72805_g(p_149674_2_, p_149674_3_, p_149674_4_));
    ...
    public void func_149670_a(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity p_149670_5_)
    {
        ...
        {
            int l = this.func_150060_c(p_149670_1_.func_72805_g(p_149670_2_, p_149670_3_, p_149670_4_));
    ...
    protected void func_150062_a(World p_150062_1_, int p_150062_2_, int p_150062_3_, int p_150062_4_, int p_150062_5_)
    {
        ...
        if (p_150062_5_ != i1)
        {
            p_150062_1_.func_72921_c(p_150062_2_, p_150062_3_, p_150062_4_, this.func_150066_d(i1), 2);
    ...
    {
        float f = 0.125F;
        return AxisAlignedBB.func_72330_a((double)((float)p_150061_1_ + f), (double)p_150061_2_, (double)((float)p_150061_3_ + f), (double)((float)(p_150061_1_ + 1) - f), (double)p_150061_2_ + 0.25D, (double)((float)(p_150061_3_ + 1) - f));
    }
