...
public class BlockDispenser extends BlockContainer
{
    ...
    private void func_149938_m(World p_149938_1_, int p_149938_2_, int p_149938_3_, int p_149938_4_)
    {
        if (!p_149938_1_.field_72995_K)
        {
            ...
            p_149938_1_.func_72921_c(p_149938_2_, p_149938_3_, p_149938_4_, b0, 2);
        }
    }
    ...
    {
        boolean flag = p_149695_1_.func_72864_z(p_149695_2_, p_149695_3_, p_149695_4_) || p_149695_1_.func_72864_z(p_149695_2_, p_149695_3_ + 1, p_149695_4_);
        ...
        if (flag && !flag1)
        {
            ...
            p_149695_1_.func_72921_c(p_149695_2_, p_149695_3_, p_149695_4_, l | 8, 4);
        }
        else if (!flag && flag1)
        {
            p_149695_1_.func_72921_c(p_149695_2_, p_149695_3_, p_149695_4_, l & -9, 4);
        }
    }
    ...
    public void func_149749_a(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        ...
        if (tileentitydispenser != null)
        {
            for (int i1 = 0; i1 < tileentitydispenser.func_70302_i_(); ++i1)
            {
                ItemStack itemstack = tileentitydispenser.func_70301_a(i1);
                ...
                if (itemstack != null)
                {
                    ...
                    while (itemstack.count > 0)
                    {
                        ...
                        float f3 = 0.05F;
                        entityitem.field_70159_w = (double)((float)this.field_149942_b.nextGaussian() * f3);
                        entityitem.field_70181_x = (double)((float)this.field_149942_b.nextGaussian() * f3 + 0.2F);
                        entityitem.field_70179_y = (double)((float)this.field_149942_b.nextGaussian() * f3);
