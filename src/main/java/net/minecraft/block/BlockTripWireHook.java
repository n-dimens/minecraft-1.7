...
public class BlockTripWireHook extends Block
{
    ...
    public void func_150136_a(World p_150136_1_, int p_150136_2_, int p_150136_3_, int p_150136_4_, boolean p_150136_5_, int p_150136_6_, boolean p_150136_7_, int p_150136_8_, int p_150136_9_)
    {
        ...
        for (k2 = 1; k2 < 42; ++k2)
        {
            ...
            if (block == Blocks.TRIPWIRE_HOOK)
            {
                ...
                if ((j3 & 3) == Direction.field_71580_e[k1])
                {
                    j2 = k2;
                }
            ...
            {
                j3 = k2 == p_150136_8_ ? p_150136_9_ : p_150136_1_.func_72805_g(l2, p_150136_3_, i3);
        ...
        if (j2 > 0)
        {
            ...
            k3 = Direction.field_71580_e[k1];
            p_150136_1_.func_72921_c(l2, p_150136_3_, i3, k3 | k2, 3);
        ...
        if (flag2 != flag4)
        {
            for (l2 = 1; l2 < j2; ++l2)
            {
                ...
                if (j3 >= 0)
                {
                    ...
                    p_150136_1_.func_72921_c(i3, p_150136_3_, k3, j3, 3);
                }
            }
        }
    }
    ...
    {
        int l = p_149719_1_.func_72805_g(p_149719_2_, p_149719_3_, p_149719_4_) & 3;
        float f = 0.1875F;
