...
public class BlockCauldron extends Block
{
    ...
    {
        int l = func_150027_b(p_149670_1_.func_72805_g(p_149670_2_, p_149670_3_, p_149670_4_));
        float f = (float)p_149670_3_ + (6.0F + (float)(3 * l)) / 16.0F;

        if (!p_149670_1_.field_72995_K && p_149670_5_.func_70027_ad() && l > 0 && p_149670_5_.field_70121_D.field_72338_b <= (double)f)
        {
    ...
    public void func_149639_l(World p_149639_1_, int p_149639_2_, int p_149639_3_, int p_149639_4_)
    {
        ...
        {
            int l = p_149639_1_.func_72805_g(p_149639_2_, p_149639_3_, p_149639_4_);

            if (l < 3)
            {
                p_149639_1_.func_72921_c(p_149639_2_, p_149639_3_, p_149639_4_, l + 1, 2);
            }
        }
    }
    ...
    {
        int i1 = p_149736_1_.func_72805_g(p_149736_2_, p_149736_3_, p_149736_4_);
    ...
    {
        int j = MathHelper.func_76125_a(p_150025_0_, 0, 3);
