...
public class BlockStairs extends Block
{
    ...
    {
        int l = p_150147_1_.func_72805_g(p_150147_2_, p_150147_3_, p_150147_4_);
    ...
    private boolean func_150146_f(IBlockAccess p_150146_1_, int p_150146_2_, int p_150146_3_, int p_150146_4_, int p_150146_5_)
    {
        ...
        return func_150148_a(block) && p_150146_1_.func_72805_g(p_150146_2_, p_150146_3_, p_150146_4_) == p_150146_5_;
    }
    ...
    public boolean func_150145_f(IBlockAccess p_150145_1_, int p_150145_2_, int p_150145_3_, int p_150145_4_)
    {
        ...
        if (i1 == 0)
        {
            ...
            j1 = p_150145_1_.func_72805_g(p_150145_2_ + 1, p_150145_3_, p_150145_4_);
        ...
        else if (i1 == 2)
        {
            ...
            j1 = p_150145_1_.func_72805_g(p_150145_2_, p_150145_3_, p_150145_4_ + 1);
    ...
    public boolean func_150144_g(IBlockAccess p_150144_1_, int p_150144_2_, int p_150144_3_, int p_150144_4_)
    {
        ...
        if (i1 == 0)
        {
            ...
            j1 = p_150144_1_.func_72805_g(p_150144_2_ - 1, p_150144_3_, p_150144_4_);
        ...
        else if (i1 == 2)
        {
            ...
            j1 = p_150144_1_.func_72805_g(p_150144_2_, p_150144_3_, p_150144_4_ - 1);
    ...
    public void func_149689_a(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        if (l == 0)
        {
            p_149689_1_.func_72921_c(p_149689_2_, p_149689_3_, p_149689_4_, 2 | i1, 2);
        }

        if (l == 1)
        {
            p_149689_1_.func_72921_c(p_149689_2_, p_149689_3_, p_149689_4_, 1 | i1, 2);
        }

        if (l == 2)
        {
            p_149689_1_.func_72921_c(p_149689_2_, p_149689_3_, p_149689_4_, 3 | i1, 2);
        }

        if (l == 3)
        {
            p_149689_1_.func_72921_c(p_149689_2_, p_149689_3_, p_149689_4_, 0 | i1, 2);
        }
    }
    ...
    public MovingObjectPosition func_149731_a(World p_149731_1_, int p_149731_2_, int p_149731_3_, int p_149731_4_, Vec3 p_149731_5_, Vec3 p_149731_6_)
    {
        ...
        int l = p_149731_1_.func_72805_g(p_149731_2_, p_149731_3_, p_149731_4_);
        int i1 = l & 3;
        boolean flag = (l & 4) == 4;
        ...
        for (int j2 = 0; j2 < i2; ++j2)
        {
            ...
            {
                double d0 = movingobjectposition.field_72307_f.func_72436_e(p_149731_6_);
