...
public class BlockFenceGate extends BlockDirectional
{
    ...
    public boolean func_149727_a(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        if (func_149896_b(i1))
        {
            p_149727_1_.func_72921_c(p_149727_2_, p_149727_3_, p_149727_4_, i1 & -5, 2);
        }
        else
        {
            int j1 = (MathHelper.func_76128_c((double)(p_149727_5_.field_70177_z * 4.0F / 360.0F) + 0.5D) & 3) % 4;
            ...
            p_149727_1_.func_72921_c(p_149727_2_, p_149727_3_, p_149727_4_, i1 | 4, 2);
        }
    ...
    public void func_149695_a(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        if (!p_149695_1_.field_72995_K)
        {
            ...
            if (flag || p_149695_5_.func_149744_f())
            {
                ...
                {
                    p_149695_1_.func_72921_c(p_149695_2_, p_149695_3_, p_149695_4_, l | 4, 2);
                    p_149695_1_.func_72889_a((EntityPlayer)null, 1003, p_149695_2_, p_149695_3_, p_149695_4_, 0);
                }
                else if (!flag && func_149896_b(l))
                {
                    p_149695_1_.func_72921_c(p_149695_2_, p_149695_3_, p_149695_4_, l & -5, 2);
                    p_149695_1_.func_72889_a((EntityPlayer)null, 1003, p_149695_2_, p_149695_3_, p_149695_4_, 0);
                }
            }
        }
