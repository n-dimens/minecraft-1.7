...
public class BlockCocoa extends BlockDirectional implements IGrowable
{
    ...
    public void func_149674_a(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        ...
        else if (p_149674_1_.field_73012_v.nextInt(5) == 0)
        {
            ...
            {
                ++i1;
                p_149674_1_.func_72921_c(p_149674_2_, p_149674_3_, p_149674_4_, i1 << 2 | func_149895_l(l), 2);
            }
        }
    }
    ...
    {
        int l = func_149895_l(p_149718_1_.func_72805_g(p_149718_2_, p_149718_3_, p_149718_4_));
    ...
    {
        int l = ((MathHelper.func_76128_c((double)(p_149689_5_.field_70177_z * 4.0F / 360.0F) + 0.5D) & 3) + 0) % 4;
    ...
    public void func_149651_a(IIconRegister p_149651_1_)
    {
        ...
        {
            this.field_149989_a[i] = p_149651_1_.func_94245_a(this.func_149641_N() + "_stage_" + i);
        }
    }
