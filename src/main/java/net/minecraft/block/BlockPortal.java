...
public class BlockPortal extends BlockBreakable
{
    ...
    public void func_149674_a(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        ...
        if (p_149674_1_.field_73011_w.func_76569_d() && p_149674_1_.func_82736_K().getBooleanValue("doMobSpawning") && p_149674_5_.nextInt(2000) < p_149674_1_.field_73013_u.func_151525_a())
        {
            ...
            {
                Entity entity = ItemMonsterPlacer.func_77840_a(p_149674_1_, 57, (double)p_149674_2_ + 0.5D, (double)l + 1.1D, (double)p_149674_4_ + 0.5D);
    ...
    {
        int l = func_149999_b(p_149719_1_.func_72805_g(p_149719_2_, p_149719_3_, p_149719_4_));
        ...
        if (l == 0)
        {
            ...
            {
                ((World)p_149719_1_).func_72921_c(p_149719_2_, p_149719_3_, p_149719_4_, l, 2);
            }
        }
    ...
    {
        int l = func_149999_b(p_149695_1_.func_72805_g(p_149695_2_, p_149695_3_, p_149695_4_));
    ...
    public boolean func_149646_a(IBlockAccess p_149646_1_, int p_149646_2_, int p_149646_3_, int p_149646_4_, int p_149646_5_)
    {
        ...
        {
            i1 = func_149999_b(p_149646_1_.func_72805_g(p_149646_2_, p_149646_3_, p_149646_4_));
    ...
    public static class Size
        {
            ...
            public Size(World p_i45415_1_, int p_i45415_2_, int p_i45415_3_, int p_i45415_4_, int p_i45415_5_)
            {
                ...
                if (j1 >= 0)
                {
                    this.field_150861_f = new ChunkCoordinates(p_i45415_2_ + j1 * Direction.field_71583_a[this.field_150863_d], p_i45415_3_, p_i45415_4_ + j1 * Direction.field_71581_b[this.field_150863_d]);
            ...
            protected int func_150858_a()
            {
                ...
                {
                    i = this.field_150861_f.field_71572_b + this.field_150862_g;

                    for (j = 0; j < this.field_150868_h; ++j)
                    {
                        k = this.field_150861_f.field_71574_a + j * Direction.field_71583_a[BlockPortal.field_150001_a[this.field_150865_b][1]];
                        l = this.field_150861_f.field_71573_c + j * Direction.field_71581_b[BlockPortal.field_150001_a[this.field_150865_b][1]];
                ...
                {
                    j = this.field_150861_f.field_71574_a + i * Direction.field_71583_a[BlockPortal.field_150001_a[this.field_150865_b][1]];
            ...
            public void func_150859_c()
            {
                ...
                {
                    int j = this.field_150861_f.field_71574_a + Direction.field_71583_a[this.field_150866_c] * i;
                    int k = this.field_150861_f.field_71573_c + Direction.field_71581_b[this.field_150866_c] * i;
