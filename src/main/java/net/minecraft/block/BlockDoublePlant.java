...
public class BlockDoublePlant extends BlockBush implements IGrowable
{
    ...
    {
        int l = p_149885_1_.func_72805_g(p_149885_2_, p_149885_3_, p_149885_4_);
        return !func_149887_c(l) ? l & 7 : p_149885_1_.func_72805_g(p_149885_2_, p_149885_3_ - 1, p_149885_4_) & 7;
    }
    ...
    protected void func_149855_e(World p_149855_1_, int p_149855_2_, int p_149855_3_, int p_149855_4_)
    {
        ...
        {
            int l = p_149855_1_.func_72805_g(p_149855_2_, p_149855_3_, p_149855_4_);
    ...
    public int func_149720_d(IBlockAccess p_149720_1_, int p_149720_2_, int p_149720_3_, int p_149720_4_)
    {
        ...
        return l != 2 && l != 3 ? 16777215 : p_149720_1_.func_72807_a(p_149720_2_, p_149720_4_).func_150558_b(p_149720_2_, p_149720_3_, p_149720_4_);
    }
    ...
    {
        int l = ((MathHelper.func_76128_c((double)(p_149689_5_.field_70177_z * 4.0F / 360.0F) + 0.5D) & 3) + 2) % 4;
    ...
    {
        if (p_149636_1_.field_72995_K || p_149636_2_.func_71045_bC() == null || p_149636_2_.func_71045_bC().getBaseItem() != Items.SHEARS || func_149887_c(p_149636_6_) || !this.func_149886_b(p_149636_1_, p_149636_3_, p_149636_4_, p_149636_5_, p_149636_6_, p_149636_2_))
        {
    ...
    public void func_149681_a(World p_149681_1_, int p_149681_2_, int p_149681_3_, int p_149681_4_, int p_149681_5_, EntityPlayer p_149681_6_)
    {
        if (func_149887_c(p_149681_5_))
        {
            if (p_149681_1_.func_147439_a(p_149681_2_, p_149681_3_ - 1, p_149681_4_) == this)
            {
                if (!p_149681_6_.capabilities.instabuild)
                {
                    ...
                    {
                        if (!p_149681_1_.field_72995_K && p_149681_6_.func_71045_bC() != null && p_149681_6_.func_71045_bC().getBaseItem() == Items.SHEARS)
                        {
        ...
        else if (p_149681_6_.capabilities.instabuild && p_149681_1_.func_147439_a(p_149681_2_, p_149681_3_ + 1, p_149681_4_) == this)
        {
    ...
    public void func_149651_a(IIconRegister p_149651_1_)
    {
        ...
        {
            this.field_149893_M[i] = p_149651_1_.func_94245_a("double_plant_" + field_149892_a[i] + "_bottom");
            this.field_149894_N[i] = p_149651_1_.func_94245_a("double_plant_" + field_149892_a[i] + "_top");
        }
    ...
    {
        int l = p_149643_1_.func_72805_g(p_149643_2_, p_149643_3_, p_149643_4_);
        return func_149887_c(l) ? func_149890_d(p_149643_1_.func_72805_g(p_149643_2_, p_149643_3_ - 1, p_149643_4_)) : func_149890_d(l);
    }
