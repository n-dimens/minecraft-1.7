...
public abstract class BlockRailBase extends Block
{
    ...
    public class Rail
    {
        ...
        private void func_150645_c(BlockRailBase.Rail p_150645_1_)
        {
            ...
            if (this.field_150656_f)
            {
                i = this.field_150660_b.func_72805_g(this.field_150661_c, this.field_150658_d, this.field_150659_e) & 8 | b0;
            }

            this.field_150660_b.func_72921_c(this.field_150661_c, this.field_150658_d, this.field_150659_e, i, 3);
        }
        ...
        public void func_150655_a(boolean p_150655_1_, boolean p_150655_2_)
        {
            ...
            if (p_150655_2_ || this.field_150660_b.func_72805_g(this.field_150661_c, this.field_150658_d, this.field_150659_e) != i)
            {
                this.field_150660_b.func_72921_c(this.field_150661_c, this.field_150658_d, this.field_150659_e, i, 3);
