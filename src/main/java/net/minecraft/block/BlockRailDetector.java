...
public class BlockRailDetector extends BlockRailBase
{
    ...
    public void func_149670_a(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity p_149670_5_)
    {
        ...
        {
            int l = p_149670_1_.func_72805_g(p_149670_2_, p_149670_3_, p_149670_4_);
    ...
    private void func_150054_a(World p_150054_1_, int p_150054_2_, int p_150054_3_, int p_150054_4_, int p_150054_5_)
    {
        ...
        boolean flag1 = false;
        float f = 0.125F;
        List list = p_150054_1_.func_72872_a(EntityMinecart.class, AxisAlignedBB.func_72330_a((double)((float)p_150054_2_ + f), (double)p_150054_3_, (double)((float)p_150054_4_ + f), (double)((float)(p_150054_2_ + 1) - f), (double)((float)(p_150054_3_ + 1) - f), (double)((float)(p_150054_4_ + 1) - f)));
    ...
    public int func_149736_g(World p_149736_1_, int p_149736_2_, int p_149736_3_, int p_149736_4_, int p_149736_5_)
    {
        ...
        {
            float f = 0.125F;
            List list = p_149736_1_.func_72872_a(EntityMinecartCommandBlock.class, AxisAlignedBB.func_72330_a((double)((float)p_149736_2_ + f), (double)p_149736_3_, (double)((float)p_149736_4_ + f), (double)((float)(p_149736_2_ + 1) - f), (double)((float)(p_149736_3_ + 1) - f), (double)((float)(p_149736_4_ + 1) - f)));
            ...
            List list1 = p_149736_1_.func_82733_a(EntityMinecart.class, AxisAlignedBB.func_72330_a((double)((float)p_149736_2_ + f), (double)p_149736_3_, (double)((float)p_149736_4_ + f), (double)((float)(p_149736_2_ + 1) - f), (double)((float)(p_149736_3_ + 1) - f), (double)((float)(p_149736_4_ + 1) - f)), IEntitySelector.field_96566_b);
