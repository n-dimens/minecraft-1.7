...
public class BlockOldLeaf extends BlockLeaves
{
    ...
    public int func_149720_d(IBlockAccess p_149720_1_, int p_149720_2_, int p_149720_3_, int p_149720_4_)
    {
        ...
        return (l & 3) == 1 ? ColorizerFoliage.func_77466_a() : ((l & 3) == 2 ? ColorizerFoliage.func_77469_b() : super.func_149720_d(p_149720_1_, p_149720_2_, p_149720_3_, p_149720_4_));
    }
    ...
    public void func_149651_a(IIconRegister p_149651_1_)
    {
        for (int i = 0; i < field_150130_N.length; ++i)
        {
            ...
            {
                this.field_150129_M[i][j] = p_149651_1_.func_94245_a(field_150130_N[i][j]);
            }
        }
    }
