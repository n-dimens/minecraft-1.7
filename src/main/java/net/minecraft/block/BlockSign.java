...
public class BlockSign extends BlockContainer
{
    ...
    public void func_149695_a(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        else
        {
            ...
            if (l == 2 && p_149695_1_.func_147439_a(p_149695_2_, p_149695_3_, p_149695_4_ + 1).func_149688_o().func_76220_a())
            {
                flag = false;
            }

            if (l == 3 && p_149695_1_.func_147439_a(p_149695_2_, p_149695_3_, p_149695_4_ - 1).func_149688_o().func_76220_a())
            {
                flag = false;
            }

            if (l == 4 && p_149695_1_.func_147439_a(p_149695_2_ + 1, p_149695_3_, p_149695_4_).func_149688_o().func_76220_a())
            {
                flag = false;
            }

            if (l == 5 && p_149695_1_.func_147439_a(p_149695_2_ - 1, p_149695_3_, p_149695_4_).func_149688_o().func_76220_a())
            {
                flag = false;
            }
        }
