...
public class BlockTNT extends Block
{
    ...
    public void func_149723_a(World p_149723_1_, int p_149723_2_, int p_149723_3_, int p_149723_4_, Explosion p_149723_5_)
    {
        ...
        {
            EntityTNTPrimed entitytntprimed = new EntityTNTPrimed(p_149723_1_, (double)((float)p_149723_2_ + 0.5F), (double)((float)p_149723_3_ + 0.5F), (double)((float)p_149723_4_ + 0.5F), p_149723_5_.func_94613_c());
            entitytntprimed.field_70516_a = p_149723_1_.field_73012_v.nextInt(entitytntprimed.field_70516_a / 4) + entitytntprimed.field_70516_a / 8;
            p_149723_1_.func_72838_d(entitytntprimed);
        }
    }
    ...
    public void func_150114_a(World p_150114_1_, int p_150114_2_, int p_150114_3_, int p_150114_4_, int p_150114_5_, EntityLivingBase p_150114_6_)
    {
        if (!p_150114_1_.field_72995_K)
        {
            if ((p_150114_5_ & 1) == 1)
            {
                ...
                p_150114_1_.func_72838_d(entitytntprimed);
                p_150114_1_.func_72956_a(entitytntprimed, "game.tnt.primed", 1.0F, 1.0F);
            }
        }
    }
    ...
    {
        if (p_149727_5_.func_71045_bC() != null && p_149727_5_.func_71045_bC().func_77973_b() == Items.FLINT_AND_STEEL)
        {
    ...
    public void func_149670_a(World p_149670_1_, int p_149670_2_, int p_149670_3_, int p_149670_4_, Entity p_149670_5_)
    {
        if (p_149670_5_ instanceof EntityArrow && !p_149670_1_.field_72995_K)
        {
            ...
            {
                this.func_150114_a(p_149670_1_, p_149670_2_, p_149670_3_, p_149670_4_, 1, entityarrow.field_70250_c instanceof EntityLivingBase ? (EntityLivingBase)entityarrow.field_70250_c : null);
