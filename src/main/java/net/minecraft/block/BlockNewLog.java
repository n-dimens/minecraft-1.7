...
public class BlockNewLog extends BlockLog
{
    ...
    public void func_149651_a(IIconRegister p_149651_1_)
    {
        ...
        {
            this.field_150167_a[i] = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + field_150169_M[i]);
            this.field_150166_b[i] = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + field_150169_M[i] + "_top");
        }
    }
}