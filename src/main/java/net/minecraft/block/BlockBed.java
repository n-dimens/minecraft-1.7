    ...
    public boolean func_149727_a(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        else
        {
            ...
            if (!func_149975_b(i1))
            {
                ...
                i1 = p_149727_1_.func_72805_g(p_149727_2_, p_149727_3_, p_149727_4_);
            }
            ...
            if (p_149727_1_.field_73011_w.func_76567_e() && p_149727_1_.func_72807_a(p_149727_2_, p_149727_4_) != BiomeGenBase.field_76778_j)
            {
                if (func_149976_c(i1))
                {
                    ...
                    Iterator iterator = p_149727_1_.field_73010_i.iterator();
                    ...
                    while (iterator.hasNext())
                    {
                        ...
                        if (entityplayer2.func_70608_bn())
                        {
                            ...
                            if (chunkcoordinates.field_71574_a == p_149727_2_ && chunkcoordinates.field_71572_b == p_149727_3_ && chunkcoordinates.field_71573_c == p_149727_4_)
                            {
    ...
    public static ChunkCoordinates func_149977_a(World p_149977_0_, int p_149977_1_, int p_149977_2_, int p_149977_3_, int p_149977_4_)
    {
        ...
        for (int k1 = 0; k1 <= 1; ++k1)
        {
            ...
            for (int l2 = l1; l2 <= j2; ++l2)
            {
                ...
                {
                    if (World.func_147466_a(p_149977_0_, l2, p_149977_2_ - 1, i3) && !p_149977_0_.func_147439_a(l2, p_149977_2_, i3).func_149688_o().func_76218_k() && !p_149977_0_.func_147439_a(l2, p_149977_2_ + 1, i3).func_149688_o().func_76218_k())
                    {
                        if (p_149977_4_ <= 0)
                        {
