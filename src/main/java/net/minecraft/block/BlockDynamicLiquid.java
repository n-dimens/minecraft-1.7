...
public class BlockDynamicLiquid extends BlockLiquid
{
    ...
    {
        int l = p_149811_1_.func_72805_g(p_149811_2_, p_149811_3_, p_149811_4_);
    ...
    public void func_149674_a(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        ...
        if (l > 0)
        {
            ...
            else
            {
                ...
                {
                    p_149674_1_.func_72921_c(p_149674_2_, p_149674_3_, p_149674_4_, j1, 2);
    ...
    private void func_149813_h(World p_149813_1_, int p_149813_2_, int p_149813_3_, int p_149813_4_, int p_149813_5_)
    {
        if (this.func_149809_q(p_149813_1_, p_149813_2_, p_149813_3_, p_149813_4_))
        {
            ...
            {
                block.func_149697_b(p_149813_1_, p_149813_2_, p_149813_3_, p_149813_4_, p_149813_1_.func_72805_g(p_149813_2_, p_149813_3_, p_149813_4_), 0);
            }
    ...
    private int func_149812_c(World p_149812_1_, int p_149812_2_, int p_149812_3_, int p_149812_4_, int p_149812_5_, int p_149812_6_)
    {
        ...
        for (int k1 = 0; k1 < 4; ++k1)
        {
            if ((k1 != 0 || p_149812_6_ != 1) && (k1 != 1 || p_149812_6_ != 0) && (k1 != 2 || p_149812_6_ != 3) && (k1 != 3 || p_149812_6_ != 2))
            {
                ...
                if (!this.func_149807_p(p_149812_1_, l1, p_149812_3_, i2) && (p_149812_1_.func_147439_a(l1, p_149812_3_, i2).func_149688_o() != this.field_149764_J || p_149812_1_.func_72805_g(l1, p_149812_3_, i2) != 0))
                {
    ...
    private boolean[] func_149808_o(World p_149808_1_, int p_149808_2_, int p_149808_3_, int p_149808_4_)
    {
        ...
        for (l = 0; l < 4; ++l)
        {
            ...
            if (!this.func_149807_p(p_149808_1_, i1, p_149808_3_, j1) && (p_149808_1_.func_147439_a(i1, p_149808_3_, j1).func_149688_o() != this.field_149764_J || p_149808_1_.func_72805_g(i1, p_149808_3_, j1) != 0))
            {
