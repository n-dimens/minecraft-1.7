        ...
        if (!p_149925_1_.field_72995_K)
        {
            ...
            if (tileentityjukebox != null)
            {
                ...
                if (itemstack != null)
                {
                    ...
                    float f = 0.7F;
                    double d0 = (double)(p_149925_1_.field_73012_v.nextFloat() * f) + (double)(1.0F - f) * 0.5D;
                    double d1 = (double)(p_149925_1_.field_73012_v.nextFloat() * f) + (double)(1.0F - f) * 0.2D + 0.6D;
                    double d2 = (double)(p_149925_1_.field_73012_v.nextFloat() * f) + (double)(1.0F - f) * 0.5D;
                    ...
                    p_149925_1_.func_72838_d(entityitem);
                }
            }
        }
    }
