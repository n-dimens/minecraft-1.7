...
public class BlockStainedGlassPane extends BlockPane
{
    ...
    public void func_149651_a(IIconRegister p_149651_1_)
    {
        ...
        for (int i = 0; i < field_150106_a.length; ++i)
        {
            field_150106_a[i] = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + ItemDye.field_150921_b[func_150103_c(i)]);
            field_150105_b[i] = p_149651_1_.func_94245_a(this.func_149641_N() + "_pane_top_" + ItemDye.field_150921_b[func_150103_c(i)]);
        }
    }
}