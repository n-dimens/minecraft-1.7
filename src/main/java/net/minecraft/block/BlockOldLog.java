...
public class BlockOldLog extends BlockLog
{
    ...
    public void func_149651_a(IIconRegister p_149651_1_)
    {
        ...
        {
            this.field_150167_a[i] = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + field_150168_M[i]);
            this.field_150166_b[i] = p_149651_1_.func_94245_a(this.func_149641_N() + "_" + field_150168_M[i] + "_top");
        }
    }
}