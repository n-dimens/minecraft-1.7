...
public class BlockPistonBase extends Block
{
    ...
    public IIcon func_149691_a(int p_149691_1_, int p_149691_2_)
    {
        ...
        return k > 5 ? this.field_150084_N : (p_149691_1_ == k ? (!func_150075_c(p_149691_2_) && this.field_149759_B <= 0.0D && this.field_149760_C <= 0.0D && this.field_149754_D <= 0.0D && this.field_149755_E >= 1.0D && this.field_149756_F >= 1.0D && this.field_149757_G >= 1.0D ? this.field_150084_N : this.field_150081_b) : (p_149691_1_ == Facing.field_71588_a[k] ? this.field_150083_M : this.field_149761_L));
    }
    ...
    {
        int l = p_150078_1_.func_72805_g(p_150078_2_, p_150078_3_, p_150078_4_);
        ...
        if (i1 != 7)
        {
            ...
            {
                p_150078_1_.func_72921_c(p_150078_2_, p_150078_3_, p_150078_4_, i1, 2);
    ...
    public boolean func_149696_a(World p_149696_1_, int p_149696_2_, int p_149696_3_, int p_149696_4_, int p_149696_5_, int p_149696_6_)
    {
        ...
        {
            TileEntity tileentity1 = p_149696_1_.func_147438_o(p_149696_2_ + Facing.field_71586_b[p_149696_6_], p_149696_3_ + Facing.field_71587_c[p_149696_6_], p_149696_4_ + Facing.field_71585_d[p_149696_6_]);
            ...
            {
                int j1 = p_149696_2_ + Facing.field_71586_b[p_149696_6_] * 2;
                int k1 = p_149696_3_ + Facing.field_71587_c[p_149696_6_] * 2;
                int l1 = p_149696_4_ + Facing.field_71585_d[p_149696_6_] * 2;
    ...
    public static int func_150071_a(World p_150071_0_, int p_150071_1_, int p_150071_2_, int p_150071_3_, EntityLivingBase p_150071_4_)
    {
        ...
        {
            double d0 = p_150071_4_.field_70163_u + 1.82D - (double)p_150071_4_.field_70129_M;
        ...
        int l = MathHelper.func_76128_c((double)(p_150071_4_.field_70177_z * 4.0F / 360.0F) + 0.5D) & 3;
    ...
    {
        int i1 = p_150079_2_ + Facing.field_71586_b[p_150079_5_];
        int j1 = p_150079_3_ + Facing.field_71587_c[p_150079_5_];
        int k1 = p_150079_4_ + Facing.field_71585_d[p_150079_5_];
        int l1 = 0;
        ...
        while (true)
        {
            if (l1 < 13)
            {
                ...
                if (block.func_149688_o() != Material.field_151579_a)
                {
                    ...
                    if (block.func_149656_h() != 1)
                    {
                        ...
                        i1 += Facing.field_71586_b[p_150079_5_];
                        j1 += Facing.field_71587_c[p_150079_5_];
                        k1 += Facing.field_71585_d[p_150079_5_];
                        ++l1;
                        continue;
                    }
            ...
            {
                k2 = i1 - Facing.field_71586_b[p_150079_5_];
                l2 = j1 - Facing.field_71587_c[p_150079_5_];
                i3 = k1 - Facing.field_71585_d[p_150079_5_];
                Block block1 = p_150079_1_.func_147439_a(k2, l2, i3);
                int j3 = p_150079_1_.func_72805_g(k2, l2, i3);
