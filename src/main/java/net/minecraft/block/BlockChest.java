...
public class BlockChest extends BlockContainer
{
        ...
        if (!p_149954_1_.field_72995_K)
        {
            ...
            if (block != this && block1 != this)
            {
                ...
                else
                {
                    ...
                    if (block2 == this)
                    {
                        j1 = p_149954_1_.func_72805_g(p_149954_2_ - 1, p_149954_3_, p_149954_4_);
                    }
                    else
                    {
                        j1 = p_149954_1_.func_72805_g(p_149954_2_ + 1, p_149954_3_, p_149954_4_);
            ...
            else
            {
                ...
                if (block == this)
                {
                    j1 = p_149954_1_.func_72805_g(p_149954_2_, p_149954_3_, p_149954_4_ - 1);
                }
                else
                {
                    j1 = p_149954_1_.func_72805_g(p_149954_2_, p_149954_3_, p_149954_4_ + 1);
            ...
            p_149954_1_.func_72921_c(p_149954_2_, p_149954_3_, p_149954_4_, b0, 3);
        }
    }
    ...
    public boolean func_149727_a(World p_149727_1_, int p_149727_2_, int p_149727_3_, int p_149727_4_, EntityPlayer p_149727_5_, int p_149727_6_, float p_149727_7_, float p_149727_8_, float p_149727_9_)
    {
        ...
        else
        {
            ...
            if (iinventory != null)
            {
                p_149727_5_.func_71007_a(iinventory);
            }
