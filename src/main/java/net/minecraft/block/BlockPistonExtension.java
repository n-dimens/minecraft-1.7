...
public class BlockPistonExtension extends Block
{
    ...
    public void func_149749_a(World p_149749_1_, int p_149749_2_, int p_149749_3_, int p_149749_4_, Block p_149749_5_, int p_149749_6_)
    {
        ...
        int i1 = Facing.field_71588_a[func_150085_b(p_149749_6_)];
        p_149749_2_ += Facing.field_71586_b[i1];
        p_149749_3_ += Facing.field_71587_c[i1];
    ...
    public IIcon func_149691_a(int p_149691_1_, int p_149691_2_)
    {
        ...
        return p_149691_1_ == k ? (this.field_150088_a != null ? this.field_150088_a : ((p_149691_2_ & 8) != 0 ? BlockPistonBase.func_150074_e("piston_top_sticky") : BlockPistonBase.func_150074_e("piston_top_normal"))) : (k < 6 && p_149691_1_ == Facing.field_71588_a[k] ? BlockPistonBase.func_150074_e("piston_top_normal") : BlockPistonBase.func_150074_e("piston_side"));
    }
    ...
    {
        int l = p_149743_1_.func_72805_g(p_149743_2_, p_149743_3_, p_149743_4_);
        float f = 0.25F;
        float f1 = 0.375F;
        float f2 = 0.625F;
        float f3 = 0.25F;
    ...
    public void func_149695_a(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        ...
        {
            block1.func_149695_a(p_149695_1_, p_149695_2_ - Facing.field_71586_b[l], p_149695_3_ - Facing.field_71587_c[l], p_149695_4_ - Facing.field_71585_d[l], p_149695_5_);
        }
    }
