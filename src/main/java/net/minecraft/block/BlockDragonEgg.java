...
public class BlockDragonEgg extends Block
{
    ...
    private void func_150018_e(World p_150018_1_, int p_150018_2_, int p_150018_3_, int p_150018_4_)
    {
        if (BlockFalling.func_149831_e(p_150018_1_, p_150018_2_, p_150018_3_ - 1, p_150018_4_) && p_150018_3_ >= 0)
        {
            ...
            if (!BlockFalling.field_149832_M && p_150018_1_.func_72904_c(p_150018_2_ - b0, p_150018_3_ - b0, p_150018_4_ - b0, p_150018_2_ + b0, p_150018_3_ + b0, p_150018_4_ + b0))
            {
                ...
                p_150018_1_.func_72838_d(entityfallingblock);
            }
            else
            {
    ...
    private void func_150019_m(World p_150019_1_, int p_150019_2_, int p_150019_3_, int p_150019_4_)
    {
        if (p_150019_1_.func_147439_a(p_150019_2_, p_150019_3_, p_150019_4_) == this)
        {
            ...
            {
                int i1 = p_150019_2_ + p_150019_1_.field_73012_v.nextInt(16) - p_150019_1_.field_73012_v.nextInt(16);
                int j1 = p_150019_3_ + p_150019_1_.field_73012_v.nextInt(8) - p_150019_1_.field_73012_v.nextInt(8);
                int k1 = p_150019_4_ + p_150019_1_.field_73012_v.nextInt(16) - p_150019_1_.field_73012_v.nextInt(16);

                if (p_150019_1_.func_147439_a(i1, j1, k1).field_149764_J == Material.field_151579_a)
                {
                    if (!p_150019_1_.field_72995_K)
                    {
                        p_150019_1_.func_147465_d(i1, j1, k1, this, p_150019_1_.func_72805_g(p_150019_2_, p_150019_3_, p_150019_4_), 2);
                    ...
                    else
                    {
                        ...
                        {
                            double d0 = p_150019_1_.field_73012_v.nextDouble();
                            float f = (p_150019_1_.field_73012_v.nextFloat() - 0.5F) * 0.2F;
                            float f1 = (p_150019_1_.field_73012_v.nextFloat() - 0.5F) * 0.2F;
                            float f2 = (p_150019_1_.field_73012_v.nextFloat() - 0.5F) * 0.2F;
                            double d1 = (double)i1 + (double)(p_150019_2_ - i1) * d0 + (p_150019_1_.field_73012_v.nextDouble() - 0.5D) * 1.0D + 0.5D;
                            double d2 = (double)j1 + (double)(p_150019_3_ - j1) * d0 + p_150019_1_.field_73012_v.nextDouble() * 1.0D - 0.5D;
                            double d3 = (double)k1 + (double)(p_150019_4_ - k1) * d0 + (p_150019_1_.field_73012_v.nextDouble() - 0.5D) * 1.0D + 0.5D;
                            p_150019_1_.func_72869_a("portal", d1, d2, d3, (double)f, (double)f1, (double)f2);
                        }
                    }
