...
public class BlockTripWire extends Block
{
    ...
    public void func_149726_b(World p_149726_1_, int p_149726_2_, int p_149726_3_, int p_149726_4_)
    {
        ...
        p_149726_1_.func_72921_c(p_149726_2_, p_149726_3_, p_149726_4_, l, 3);
    ...
    private void func_150138_a(World p_150138_1_, int p_150138_2_, int p_150138_3_, int p_150138_4_, int p_150138_5_)
    {
        ...
        while (i1 < 2)
        {
            ...
            while (true)
            {
                if (j1 < 42)
                {
                    int k1 = p_150138_2_ + Direction.field_71583_a[i1] * j1;
    ...
    private void func_150140_e(World p_150140_1_, int p_150140_2_, int p_150140_3_, int p_150140_4_)
    {
        ...
        if (flag1 != flag)
        {
            p_150140_1_.func_72921_c(p_150140_2_, p_150140_3_, p_150140_4_, l, 3);
    ...
    {
        int j1 = p_150139_1_ + Direction.field_71583_a[p_150139_5_];
        int k1 = p_150139_3_ + Direction.field_71581_b[p_150139_5_];
