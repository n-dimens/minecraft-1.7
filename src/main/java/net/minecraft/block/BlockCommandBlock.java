...
public class BlockCommandBlock extends BlockContainer
{
    ...
    public void func_149695_a(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_, Block p_149695_5_)
    {
        if (!p_149695_1_.field_72995_K)
        {
            ...
            if (flag && !flag1)
            {
                p_149695_1_.func_72921_c(p_149695_2_, p_149695_3_, p_149695_4_, l | 1, 4);
                p_149695_1_.func_147464_a(p_149695_2_, p_149695_3_, p_149695_4_, this, this.func_149738_a(p_149695_1_));
            }
            else if (!flag && flag1)
            {
                p_149695_1_.func_72921_c(p_149695_2_, p_149695_3_, p_149695_4_, l & -2, 4);
            }
        }
    }
    ...
    public void func_149689_a(World p_149689_1_, int p_149689_2_, int p_149689_3_, int p_149689_4_, EntityLivingBase p_149689_5_, ItemStack p_149689_6_)
    {
        ...
        {
            tileentitycommandblock.func_145993_a().func_145754_b(p_149689_6_.func_82833_r());
        }
    }
