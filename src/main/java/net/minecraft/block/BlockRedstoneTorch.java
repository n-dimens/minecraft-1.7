...
public class BlockRedstoneTorch extends BlockTorch
{
    ...
    private boolean func_150111_a(World p_150111_1_, int p_150111_2_, int p_150111_3_, int p_150111_4_, boolean p_150111_5_)
    {
        ...
        if (p_150111_5_)
        {
            list.add(new BlockRedstoneTorch.Toggle(p_150111_2_, p_150111_3_, p_150111_4_, p_150111_1_.func_82737_E()));
        }
    ...
    public int func_149709_b(IBlockAccess p_149709_1_, int p_149709_2_, int p_149709_3_, int p_149709_4_, int p_149709_5_)
    {
        ...
        {
            int i1 = p_149709_1_.func_72805_g(p_149709_2_, p_149709_3_, p_149709_4_);
    ...
    {
        int l = p_150110_1_.func_72805_g(p_150110_2_, p_150110_3_, p_150110_4_);
        return l == 5 && p_150110_1_.func_94574_k(p_150110_2_, p_150110_3_ - 1, p_150110_4_, 0) ? true : (l == 3 && p_150110_1_.func_94574_k(p_150110_2_, p_150110_3_, p_150110_4_ - 1, 2) ? true : (l == 4 && p_150110_1_.func_94574_k(p_150110_2_, p_150110_3_, p_150110_4_ + 1, 3) ? true : (l == 1 && p_150110_1_.func_94574_k(p_150110_2_ - 1, p_150110_3_, p_150110_4_, 4) ? true : l == 2 && p_150110_1_.func_94574_k(p_150110_2_ + 1, p_150110_3_, p_150110_4_, 5))));
    }
    ...
    public void func_149674_a(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_)
    {
        ...
        while (list != null && !list.isEmpty() && p_149674_1_.func_82737_E() - ((BlockRedstoneTorch.Toggle)list.get(0)).field_150844_d > 60L)
        {
            list.remove(0);
        }
            ...
            if (flag)
            {
                ...
                if (this.func_150111_a(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_, true))
                {
                    ...
                    for (int l = 0; l < 5; ++l)
                    {
                        ...
                        p_149674_1_.func_72869_a("smoke", d0, d1, d2, 0.0D, 0.0D, 0.0D);
                    }
                }
            }
        }
    ...
    public void func_149734_b(World p_149734_1_, int p_149734_2_, int p_149734_3_, int p_149734_4_, Random p_149734_5_)
    {
        if (this.field_150113_a)
        {
            ...
            if (l == 1)
            {
                p_149734_1_.func_72869_a("reddust", d0 - d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
            }
            else if (l == 2)
            {
                p_149734_1_.func_72869_a("reddust", d0 + d4, d1 + d3, d2, 0.0D, 0.0D, 0.0D);
            ...
            {
                p_149734_1_.func_72869_a("reddust", d0, d1 + d3, d2 - d4, 0.0D, 0.0D, 0.0D);
            }
            else if (l == 4)
            {
                p_149734_1_.func_72869_a("reddust", d0, d1 + d3, d2 + d4, 0.0D, 0.0D, 0.0D);
            ...
            {
                p_149734_1_.func_72869_a("reddust", d0, d1, d2, 0.0D, 0.0D, 0.0D);
            }
        }
    }
