...
public class BlockPistonMoving extends BlockContainer
{
    ...
    public void func_149719_a(IBlockAccess p_149719_1_, int p_149719_2_, int p_149719_3_, int p_149719_4_)
    {
        ...
        if (tileentitypiston != null)
        {
            ...
            this.field_149759_B = block.func_149704_x() - (double)((float)Facing.field_71586_b[l] * f);
            this.field_149760_C = block.func_149665_z() - (double)((float)Facing.field_71587_c[l] * f);
            this.field_149754_D = block.func_149706_B() - (double)((float)Facing.field_71585_d[l] * f);
            this.field_149755_E = block.func_149753_y() - (double)((float)Facing.field_71586_b[l] * f);
            this.field_149756_F = block.func_149669_A() - (double)((float)Facing.field_71587_c[l] * f);
            this.field_149757_G = block.func_149693_C() - (double)((float)Facing.field_71585_d[l] * f);
        }
    }
    ...
    public AxisAlignedBB func_149964_a(World p_149964_1_, int p_149964_2_, int p_149964_3_, int p_149964_4_, Block p_149964_5_, float p_149964_6_, int p_149964_7_)
    {
        if (p_149964_5_ != this && p_149964_5_.func_149688_o() != Material.field_151579_a)
        {
            ...
            else
            {
                ...
                {
                    axisalignedbb.field_72340_a -= (double)((float)Facing.field_71586_b[p_149964_7_] * p_149964_6_);
                }
                else
                {
                    axisalignedbb.field_72336_d -= (double)((float)Facing.field_71586_b[p_149964_7_] * p_149964_6_);
                }

                if (Facing.field_71587_c[p_149964_7_] < 0)
                {
                    axisalignedbb.field_72338_b -= (double)((float)Facing.field_71587_c[p_149964_7_] * p_149964_6_);
                }
                else
                {
                    axisalignedbb.field_72337_e -= (double)((float)Facing.field_71587_c[p_149964_7_] * p_149964_6_);
                }

                if (Facing.field_71585_d[p_149964_7_] < 0)
                {
                    axisalignedbb.field_72339_c -= (double)((float)Facing.field_71585_d[p_149964_7_] * p_149964_6_);
                }
                else
                {
                    axisalignedbb.field_72334_f -= (double)((float)Facing.field_71585_d[p_149964_7_] * p_149964_6_);
                }
