...
public class AchievementList
{
    ...
    public final static Achievement OPEN_INVENTORY = (new Achievement("achievement.openInventory", "openInventory", 0, 0, Items.field_151122_aG, null)).awardOnlyLocal().add();
    ...
    public final static Achievement ACQUIRE_IRON = (new Achievement("achievement.acquireIron", "acquireIron", 1, 4, Items.field_151042_j, BUILD_FURNACE)).add();
    public final static Achievement BUILD_HOE = (new Achievement("achievement.buildHoe", "buildHoe", 2, -3, Items.field_151017_I, BUILD_WORK_BENCH)).add();
    public final static Achievement MAKE_BREAD = (new Achievement("achievement.makeBread", "makeBread", -1, -3, Items.field_151025_P, BUILD_HOE)).add();
    public final static Achievement BAKE_CAKE = (new Achievement("achievement.bakeCake", "bakeCake", 0, -5, Items.field_151105_aU, BUILD_HOE)).add();
    ...
    public final static Achievement COOK_FISH = (new Achievement("achievement.cookFish", "cookFish", 2, 6, Items.field_151101_aQ, BUILD_FURNACE)).add();
    ...
    public final static Achievement DIAMONDS_TO_YOU = (new Achievement("achievement.diamondsToYou", "diamondsToYou", -1, 2, Items.field_151045_i, DIAMONDS)).add();
    public final static Achievement PORTAL = (new Achievement("achievement.portal", "portal", -1, 7, Blocks.field_150343_Z, DIAMONDS)).add();
    public final static Achievement GHAST = (new Achievement("achievement.ghast", "ghast", -4, 8, Items.field_151073_bk, PORTAL)).func_75987_b().add();
    public final static Achievement BLAZE_ROD = (new Achievement("achievement.blazeRod", "blazeRod", 0, 9, Items.field_151072_bj, PORTAL)).add();
    public final static Achievement POTION = (new Achievement("achievement.potion", "potion", 2, 8, Items.field_151068_bn, BLAZE_ROD)).add();
    public final static Achievement THE_END = (new Achievement("achievement.theEnd", "theEnd", 3, 10, Items.field_151061_bv, BLAZE_ROD)).func_75987_b().add();
    ...
    public final static Achievement BREED_COW = (new Achievement("achievement.breedCow", "breedCow", 7, -5, Items.field_151015_O, KILL_COW)).add();
    public final static Achievement SPAWN_WITHER = (new Achievement("achievement.spawnWither", "spawnWither", 7, 12, new ItemStack(Items.field_151144_bL, 1, 1), THE_END_2)).add();
    public final static Achievement KILL_WITHER = (new Achievement("achievement.killWither", "killWither", 7, 10, Items.field_151156_bN, SPAWN_WITHER)).add();
    ...
    public final static Achievement EXPLORE_ALL_BIOMES = (new Achievement("achievement.exploreAllBiomes", "exploreAllBiomes", 4, 8, Items.field_151175_af, THE_END)).func_150953_b(JsonSerializableSet.class).func_75987_b().add();
