...
public class CommandBroadcast extends CommandBase
{
    ...
    public void func_71515_b(ICommandSender p_71515_1_, String[] p_71515_2_)
    {
        if (p_71515_2_.length > 0 && p_71515_2_[0].length() > 0)
        {
            ...
            MinecraftServer.func_71276_C().func_71203_ab().func_148539_a(new ChatComponentTranslation("chat.type.announcement", new Object[] {p_71515_1_.func_70005_c_(), ichatcomponent}));
        }
        else
        {
