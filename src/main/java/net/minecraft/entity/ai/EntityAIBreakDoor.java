...
public class EntityAIBreakDoor extends EntityAIDoorInteract
{
    ...
    public boolean func_75253_b()
    {
        ...
        return this.field_75359_i <= 240 && !this.field_151504_e.func_150015_f(this.field_75356_a.field_70170_p, this.field_75354_b, this.field_75355_c, this.field_75352_d) && d0 < 4.0D;
    }
