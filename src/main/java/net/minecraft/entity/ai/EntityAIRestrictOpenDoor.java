...
public class EntityAIRestrictOpenDoor extends EntityAIBase
{
    ...
    public boolean func_75250_a()
    {
        ...
        else
        {
            ...
            {
                this.field_75274_b = village.func_75564_b(MathHelper.func_76128_c(this.field_75275_a.field_70165_t), MathHelper.func_76128_c(this.field_75275_a.field_70163_u), MathHelper.func_76128_c(this.field_75275_a.field_70161_v));
