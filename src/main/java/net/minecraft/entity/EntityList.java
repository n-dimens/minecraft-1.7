...
public class EntityList
{
    ...
    public static Entity func_75620_a(String p_75620_0_, World p_75620_1_)
    {
        ...
        try
        {
            Class oclass = (Class)field_75625_b.get(p_75620_0_);
    ...
    public static Entity func_75616_a(int p_75616_0_, World p_75616_1_)
    {
        ...
        try
        {
            Class oclass = func_90035_a(p_75616_0_);
    ...
    public static int func_75619_a(Entity p_75619_0_)
    {
        ...
        return field_75624_e.containsKey(oclass) ? ((Integer)field_75624_e.get(oclass)).intValue() : 0;
    }
    ...
    {
        Class oclass = func_90035_a(p_75617_0_);
        return oclass != null ? (String)field_75626_c.get(oclass) : null;
    }
