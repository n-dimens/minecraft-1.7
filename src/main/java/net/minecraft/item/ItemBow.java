...
public class ItemBow extends Item
{
    ...
    {
        boolean flag = p_77615_3_.capabilities.instabuild || EnchantmentHelper.func_77506_a(Enchantment.field_77342_w.field_77352_x, p_77615_1_) > 0;

        if (flag || p_77615_3_.inventory.func_146028_b(Items.ARROW))
        {
            ...
            p_77615_2_.func_72956_a(p_77615_3_, "random.bow", 1.0F, 1.0F / (randomizer.nextFloat() * 0.4F + 1.2F) + f * 0.5F);
    ...
    {
        if (p_77659_3_.capabilities.instabuild || p_77659_3_.inventory.func_146028_b(Items.ARROW))
        {
