...
public class RecipesFood
{
    ...
    public void func_77608_a(CraftingManager p_77608_1_)
    {
        ...
        p_77608_1_.func_92103_a(new ItemStack(Items.field_151106_aX, 8), new Object[] {"#X#", 'X', new ItemStack(Items.field_151100_aR, 1, 3), '#', Items.field_151015_O});
        p_77608_1_.func_92103_a(new ItemStack(Blocks.field_150440_ba), new Object[] {"MMM", "MMM", "MMM", 'M', Items.field_151127_ba});
        p_77608_1_.func_92103_a(new ItemStack(Items.field_151081_bc), new Object[] {"M", 'M', Items.field_151127_ba});
        p_77608_1_.func_92103_a(new ItemStack(Items.field_151080_bb, 4), new Object[] {"M", 'M', Blocks.field_150423_aK});
