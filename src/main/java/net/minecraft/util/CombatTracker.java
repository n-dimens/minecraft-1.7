            ...
            if (combatentry != null && combatentry1.func_94560_a() == DamageSource.field_76379_h)
            {
                ...
                if (combatentry.func_94560_a() != DamageSource.field_76379_h && combatentry.func_94560_a() != DamageSource.field_76380_i)
                {
                    if (ichatcomponent1 != null && (ichatcomponent == null || !ichatcomponent1.equals(ichatcomponent)))
                    {
                        ...
                        {
                            object = new ChatComponentTranslation("death.fell.assist.item", new Object[] {this.field_94554_b.func_145748_c_(), ichatcomponent1, itemstack1.func_151000_E()});
                        }
                        else
                        {
                            object = new ChatComponentTranslation("death.fell.assist", new Object[] {this.field_94554_b.func_145748_c_(), ichatcomponent1});
                        }
                    }
                    else if (ichatcomponent != null)
                    {
                        ...
                        {
                            object = new ChatComponentTranslation("death.fell.finish.item", new Object[] {this.field_94554_b.func_145748_c_(), ichatcomponent, itemstack.func_151000_E()});
                        }
                        else
                        {
                            object = new ChatComponentTranslation("death.fell.finish", new Object[] {this.field_94554_b.func_145748_c_(), ichatcomponent});
                        }
                    }
                    else
                    {
                        object = new ChatComponentTranslation("death.fell.killer", new Object[] {this.field_94554_b.func_145748_c_()});
                    }
                }
                else
                {
                    object = new ChatComponentTranslation("death.fell.accident." + this.func_94548_b(combatentry), new Object[] {this.field_94554_b.func_145748_c_()});
                }
            }
            else
            {
