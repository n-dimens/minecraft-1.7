...
public class Vec3
{
    ...
    public Vec3 func_72432_b()
    {
        ...
        return d0 < 1.0E-4D ? func_72443_a(0.0D, 0.0D, 0.0D) : func_72443_a(this.field_72450_a / d0, this.field_72448_b / d0, this.field_72449_c / d0);
    }
    ...
    public Vec3 func_72429_b(Vec3 p_72429_1_, double p_72429_2_)
    {
        ...
        else
        {
            ...
            return d4 >= 0.0D && d4 <= 1.0D ? func_72443_a(this.field_72450_a + d1 * d4, this.field_72448_b + d2 * d4, this.field_72449_c + d3 * d4) : null;
        }
    }
    ...
    public void func_72446_c(float p_72446_1_)
    {
        ...
        float f2 = MathHelper.func_76126_a(p_72446_1_);
        double d0 = this.field_72450_a * (double)f1 + this.field_72448_b * (double)f2;
        double d1 = this.field_72448_b * (double)f1 - this.field_72450_a * (double)f2;
