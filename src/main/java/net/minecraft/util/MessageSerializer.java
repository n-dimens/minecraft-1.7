...
public class MessageSerializer extends MessageToByteEncoder
{
    ...
    {
        Integer integer = (Integer)((BiMap)p_encode_1_.channel().attr(NetworkManager.field_150737_e).get()).inverse().get(p_encode_2_.getClass());

        if (field_150798_a.isDebugEnabled())
        {
            field_150798_a.debug(field_150797_b, "OUT: [{}:{}] {}[{}]", new Object[] {p_encode_1_.channel().attr(NetworkManager.field_150739_c).get(), integer, p_encode_2_.getClass().getName(), p_encode_2_.func_148835_b()});
        }
