    ...
    public static class Serializer implements JsonDeserializer, JsonSerializer
        {
                    ...
                    else
                    {
                        ...
                        if (jsonobject.has("clickEvent"))
                        {
                            ...
                            if (jsonobject1 != null)
                            {
                                ...
                                ClickEvent.Action action = jsonprimitive == null ? null : ClickEvent.Action.func_150672_a(jsonprimitive.getAsString());
                        ...
                        if (jsonobject.has("hoverEvent"))
                        {
                            ...
                            {
                                jsonprimitive = jsonobject1.getAsJsonPrimitive("action");
                                HoverEvent.Action action1 = jsonprimitive == null ? null : HoverEvent.Action.func_150684_a(jsonprimitive.getAsString());
            ...
            public JsonElement serialize(ChatStyle p_serialize_1_, Type p_serialize_2_, JsonSerializationContext p_serialize_3_)
            {
                ...
                else
                {
                    ...
                    {
                        jsonobject1 = new JsonObject();
                        jsonobject1.addProperty("action", p_serialize_1_.field_150252_i.func_150701_a().func_150685_b());
                        jsonobject1.add("value", p_serialize_3_.serialize(p_serialize_1_.field_150252_i.func_150702_b()));
