    ...
    public void func_148840_b(PacketBuffer p_148840_1_) throws IOException
    {
        ...
        while (iterator.hasNext())
        {
            ...
            while (iterator1.hasNext())
            {
                ...
                p_148840_1_.writeLong(attributemodifier.func_111167_a().getMostSignificantBits());
                p_148840_1_.writeLong(attributemodifier.func_111167_a().getLeastSignificantBits());
