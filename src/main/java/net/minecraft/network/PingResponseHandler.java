            ...
            try
            {
                ...
                switch (i)
                {
                    case 0:
                        ...
                        s = String.format("%s\u00a7%d\u00a7%d", new Object[] {minecraftserver.func_71273_Y(), Integer.valueOf(minecraftserver.func_71233_x()), Integer.valueOf(minecraftserver.func_71275_y())});
                    ...
                    case 1:
                        ...
                        s = String.format("\u00a71\u0000%d\u0000%s\u0000%s\u0000%d\u0000%d", new Object[] {Integer.valueOf(127), minecraftserver.func_71249_w(), minecraftserver.func_71273_Y(), Integer.valueOf(minecraftserver.func_71233_x()), Integer.valueOf(minecraftserver.func_71275_y())});
                        this.func_151256_a(p_channelRead_1_, this.func_151255_a(s));
                        break;
                    default:
