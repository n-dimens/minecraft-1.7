...
public abstract class Container
{
        ...
        else
        {
            ...
            if ((p_75144_3_ == 0 || p_75144_3_ == 1) && (p_75144_2_ == 0 || p_75144_2_ == 1))
            {
                ...
                else if (p_75144_3_ == 1)
                {
                    ...
                    if (slot2 != null && slot2.func_82869_a(p_75144_4_))
                    {
                        itemstack3 = this.func_82846_b(p_75144_4_, p_75144_1_);
            ...
            else if (p_75144_3_ == 2 && p_75144_2_ >= 0 && p_75144_2_ < 9)
            {
                ...
                {
                    itemstack3 = inventoryplayer.func_70301_a(p_75144_2_);
            ...
            {
                slot2 = (Slot)this.field_75151_b.get(p_75144_1_);
                itemstack3 = inventoryplayer.func_70445_o();

                if (itemstack3 != null && (slot2 == null || !slot2.func_75216_d() || !slot2.func_82869_a(p_75144_4_)))
                {
                    i1 = p_75144_2_ == 0 ? 0 : this.field_75151_b.size() - 1;
                    l1 = p_75144_2_ == 0 ? 1 : -1;
    ...
    {
        boolean flag1 = p_94527_0_ == null || !p_94527_0_.func_75216_d();
