...
public class EnchantmentProtection extends Enchantment
{
    ...
    {
        int j = EnchantmentHelper.func_77511_a(Enchantment.field_77329_d.field_77352_x, p_92093_0_.func_70035_c());

        if (j > 0)
        {
            p_92093_1_ -= MathHelper.func_76141_d((float)p_92093_1_ * (float)j * 0.15F);
        }
