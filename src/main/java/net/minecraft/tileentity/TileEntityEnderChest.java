...
public class TileEntityEnderChest extends TileEntity
{
    ...
    public void func_145845_h()
    {
        ...
        if (this.field_145973_j > 0 && this.field_145972_a == 0.0F)
        {
            ...
            this.field_145850_b.func_72908_a(d0, (double)this.field_145848_d + 0.5D, d1, "random.chestopen", 0.5F, this.field_145850_b.field_73012_v.nextFloat() * 0.1F + 0.9F);
        }
        ...
        if (this.field_145973_j == 0 && this.field_145972_a > 0.0F || this.field_145973_j > 0 && this.field_145972_a < 1.0F)
        {
            ...
            if (this.field_145972_a < f1 && f2 >= f1)
            {
                ...
                this.field_145850_b.func_72908_a(d1, (double)this.field_145848_d + 0.5D, d2, "random.chestclosed", 0.5F, this.field_145850_b.field_73012_v.nextFloat() * 0.1F + 0.9F);
            }
