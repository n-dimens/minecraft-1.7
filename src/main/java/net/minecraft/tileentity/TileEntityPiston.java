        ...
        if (axisalignedbb != null)
        {
            ...
            if (!list.isEmpty())
            {
                ...
                while (iterator.hasNext())
                {
                    ...
                    entity.func_70091_d((double)(p_145863_2_ * (float)Facing.field_71586_b[this.field_145874_j]), (double)(p_145863_2_ * (float)Facing.field_71587_c[this.field_145874_j]), (double)(p_145863_2_ * (float)Facing.field_71585_d[this.field_145874_j]));
                }
